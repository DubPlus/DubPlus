...
var DubPlus = (function () {
  ...
  function () {
    function UserSettings() {
      ...
      _defineProperty(this, "srcRoot", "https://cdn.jsdelivr.net/gh//DubPlus@beta_fixes/DubPlus_Logo_Owners");
  ...
  */
  ...
  function load(cssFile, className) {
    ...
    var link = makeLink(className, userSettings.srcRoot + cssFile + "?" + 1571519826421);
