...
"use strict";var css=require("../utils/css.js"),myModule={};myModule.id="dubplus-comm-theme",myModule.moduleName="Community Theme",myModule.description="Toggle Community CSS theme.",myModule.category="Customize",myModule.turnOn=function(){var a=QueUp.room.model.get("roomUrl");$.ajax({type:"GET",url:"https://api.dubtrack.fm/room/"+a}).done(function(b){var c=b.data.description,d=new RegExp(/(@dub(x|plus|\+)=)((https?:\/\/)?[\w-]+(\.[\w-]+)+\.?(:\d+)?(\/\S*)?)/,"i"),f=null;c.replace(d,function(g,h,i,j){console.log("loading community css theme:",j),f=j});f&&css.loadExternal(f,"dubplus-comm-theme")})},myModule.turnOff=function(){$(".dubplus-comm-theme").remove()},module.exports=myModule;
