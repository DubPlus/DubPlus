...
"use strict";var _waitFor=_interopRequireDefault(require("./utils/waitFor.js")),_preload=_interopRequireDefault(require("./utils/preload.js"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var modal=require("./utils/modal.js"),init=require("./lib/init.js"),css=require("./utils/css.js");function errorModal(e){css.load("/css/dubplus.css","dubplus-css"),modal.create({title:"Dub+ Error",content:e})}if((0,_preload.default)(),window.dubplus){var _document$querySelect;for(var key in window.dubplus)"function"==typeof window.dubplus[key].turnOff&&window.dubplus[key].turnOff();null===(_document$querySelect=document.querySelector(".dubplus-menu"))||void 0===_document$querySelect||_document$querySelect.remove()}(0,_preload.default)();var checkList=["QueUp.session.id","QueUp.room.chat","QueUp.Events","QueUp.room.player","QueUp.helpers.cookie","QueUp.room.model","QueUp.room.users"],dubplusWaiting=new _waitFor.default(checkList,{seconds:10});dubplusWaiting.then(function(){init(),$(".dubplus-waiting").remove()}).fail(function(){QueUp.session.id?$(".dubplus-waiting span").text("Something happed, refresh and try again"):errorModal("You're not logged in. Please login to use Dub+.")});
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var options=require("../utils/options.js"),dubPlus_modules=require("../modules/index.js"),settings=require("../lib/settings.js"),menu=require("../lib/menu.js"),menuObj={General:"","User Interface":"",Settings:"",Customize:""};function loadAllModules(){return dubPlus_modules.forEach(function(e){window.dubplus[e.id]=e,window.dubplus[e.id].toggleAndSave=options.toggleAndSave,e.optionState=settings.options[e.id]||!1,"function"==typeof e.init&&e.init.call(e),e.optionState&&"function"==typeof e.turnOn&&e.turnOn.call(e);var t=null;"function"!=typeof e.extra||e.extraIcon||(t="pencil"),menuObj[e.category]||(menuObj[e.category]=new DocumentFragment),menuObj[e.category].appendChild(menu.makeOptionMenu(e.moduleName,{id:e.id,desc:e.description,state:e.optionState,extraIcon:e.extraIcon||t,cssClass:e.menuCssClass||"",altIcon:e.altIcon||null}))}),menuObj}var _default=exports.default=loadAllModules;

},{"../lib/menu.js":7,"../lib/settings.js":8,"../modules/index.js":29,"../utils/options.js":46}],6:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.onMenuAction=onMenuAction,exports.onMenuEdit=onMenuEdit,exports.onMenuToggle=onMenuToggle,exports.toggleMenu=toggleMenu,exports.toggleMenuSection=toggleMenuSection;var options=require("../utils/options.js");function toggleMenuSection(e){var n=document.getElementById(e),t=n.querySelector(".fa"),o=n.nextElementSibling,u=n.textContent.trim().replace(" ","-").toLowerCase();o.classList.toggle("dubplus-menu-section-closed");var l=o.classList.contains("dubplus-menu-section-closed");t.classList.toggle("fa-angle-down"),t.classList.toggle("fa-angle-right"),options.saveOption("menu",u,l?"closed":"open")}function onMenuEdit(e){var n=window.dubplus[e];n&&n.extra&&n.extra.call(n)}function onMenuToggle(e){var n=window.dubplus[e];n&&n.turnOn&&n.turnOff&&(n.optionState?n.turnOff.call(n):n.turnOn.call(n),n.optionState=!n.optionState,options.toggleAndSave(n.id,n.optionState))}function onMenuAction(e){var n=window.dubplus[e];n&&n.go&&n.go.call(n)}function toggleMenu(){document.querySelector(".dubplus-menu").classList.toggle("dubplus-menu-open")}

},{"../utils/options.js":46}],7:[function(require,module,exports){
"use strict";var _menuEvents=_interopRequireDefault(require("./menu-events.js"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var settings=require("./settings.js"),css=require("../utils/css.js"),arrow="down",isClosedClass="";function makeContactSection(){var e=new DocumentFragment,t=document.createElement("div");t.id="dubplus-contact",t.className="dubplus-menu-section-header",t.innerHTML='\n    <span class="fa fa-angle-'.concat(arrow,'"></span>\n    <p>Contact</p>\n  '),t.setAttribute("onclick","window.dubplus.toggleMenuSection('dubplus-contact')"),e.appendChild(t);var n=document.createElement("ul");return n.className="dubplus-menu-section ".concat(isClosedClass),[{icon:"bug",link:"https://discord.gg/XUkG3Qy",text:"Report bugs on Discord"},{icon:"reddit-alien",link:"https://www.reddit.com/r/DubPlus/",text:"Reddit"},{icon:"facebook",link:"https://facebook.com/DubPlusScript",text:"Facebook"},{icon:"twitter",link:"https://twitter.com/DubPlusScript",text:"Twitter"}].forEach(function(e){var t=document.createElement("li");t.className="dubplus-menu-icon",t.innerHTML='\n      <span class="fa fa-'.concat(e.icon,'"></span>\n      <a href="').concat(e.link,'" class="dubplus-menu-label" target="_blank">').concat(e.text,"</a>\n    "),n.appendChild(t)}),e.appendChild(n),e}"closed"===settings.menu.contact&&(isClosedClass="dubplus-menu-section-closed",arrow="right"),module.exports={beginMenu:function(){var e;css.loadExternal("https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css","dubplus-font-awesome"),null===(e=document.querySelector(".dubplus-icon"))||void 0===e||e.remove();var t=document.createElement("div");t.className="dubplus-icon";var n=document.createElement("img");n.src="".concat(settings.srcRoot,"/images/dubplus.svg"),n.alt="",t.appendChild(n),t.setAttribute("onclick","window.dubplus.toggleMenu()"),document.querySelector(".header-right-navigation").appendChild(t);var a=document.createElement("section");a.className="dubplus-menu";var c=document.createElement("p");return c.className="dubplus-menu-header",c.textContent="Dub+ Options",a.appendChild(c),a},finishMenu:function(e,t){for(var n in e){var a=n.replace(" ","-").toLowerCase(),c="dubplus-"+a,s="down",o="";"closed"===settings.menu[a]&&(o="dubplus-menu-section-closed",s="right");var u=document.createElement("div");u.id=c,u.className="dubplus-menu-section-header";var l=document.createElement("span");l.className="fa fa-angle-".concat(s);var i=document.createElement("p");i.textContent=n,u.appendChild(l),u.appendChild(i),u.setAttribute("onclick","window.dubplus.toggleMenuSection('".concat(c,"')"));var d=document.createElement("ul");d.className="dubplus-menu-section ".concat(o),d.appendChild(e[n]),t.appendChild(u),t.appendChild(d)}t.appendChild(makeContactSection()),document.body.appendChild(t)},makeOptionMenu:function(e,t){var n,a=Object.assign({},{id:"",desc:"",state:!1,extraIcon:null,cssClass:"",altIcon:null},t),c=a.state?"dubplus-switch-on":"",s="dubplus-switch";if(t.altIcon)s="dubplus-menu-icon",(n=document.createElement("span")).className="fa fa-".concat(a.altIcon),n.setAttribute("onclick","window.dubplus.onMenuAction('".concat(a.id,"')"));else{(n=document.createElement("div")).className="dubplus-switch-bg";var o=document.createElement("div");o.className="dubplus-switcher",n.appendChild(o),n.setAttribute("onclick","window.dubplus.onMenuToggle('".concat(a.id,"')"))}var u=document.createElement("li");if(u.id=a.id,u.className="".concat(s," ").concat(c," ").concat(a.cssClass).trim(),u.title=a.desc,a.extraIcon){var l=document.createElement("span");l.className="fa fa-".concat(a.extraIcon," extra-icon"),l.setAttribute("onclick","window.dubplus.onMenuEdit('".concat(a.id,"')")),u.appendChild(l)}u.appendChild(n);var i=document.createElement("span");return i.className="dubplus-menu-label",i.textContent=e,u.appendChild(i),u}};
...
"use strict";var _previewList=require("../emojiUtils/previewList.js"),settings=require("../lib/settings.js"),prepEmjoji=require("../emojiUtils/prepEmoji.js"),debugAC=!1;function log(){debugAC&&console.log.apply(console,arguments)}var myModule={id:"dubplus-autocomplete",moduleName:"Autocomplete Emoji",description:"Toggle autocompleting emojis and emotes.  Shows a preview box in the chat",category:"General"},KEYS={up:38,down:40,left:37,right:39,enter:13,esc:27,tab:9,shiftKey:16,backspace:8,del:46,space:32,ctrl:17},keyCharMin=3,inputRegex=new RegExp("(:)([&!()\\+\\-_a-z0-9]+)($|\\s)","ig"),emojiUtils={createPreviewObj:function(e,t,i){return{src:prepEmjoji[e].template(t),text:":"+i+":",alt:i,cn:e}},addToPreviewList:function(e){var t,i=this,r=[];e.forEach(function(e){t=e.toLowerCase(),void 0!==prepEmjoji.twitch.emotes[t]&&r.push(i.createPreviewObj("twitch",prepEmjoji.twitch.emotes[t],e)),void 0!==prepEmjoji.bttv.emotes[t]&&r.push(i.createPreviewObj("bttv",prepEmjoji.bttv.emotes[t],e)),void 0!==prepEmjoji.tasty.emotes[t]&&r.push(i.createPreviewObj("tasty",t,e)),void 0!==prepEmjoji.frankerFacez.emotes[t]&&r.push(i.createPreviewObj("frankerFacez",prepEmjoji.frankerFacez.emotes[t],e)),emojify.emojiNames.indexOf(t)>=0&&r.push(i.createPreviewObj("emoji",e,e))}),(0,_previewList.makeList)(r)},filterEmoji:function(e){var t=e.replace(/([+()])/,"\\$1"),i=new RegExp("^"+t,"i"),r=emojify.emojiNames||[];return settings.options["dubplus-emotes"]&&(r=prepEmjoji.emojiEmotes||[]),r.filter(function(e){return i.test(e)})}},previewList=new _previewList.PreviewListManager,shouldClearPreview=function(e,t,i,r){var o=i.charAt(i.length-1);return(t.length<r||":"===o||" "===o||""===i)&&(t="",e.innerHTML="",e.className=""),t},handleMatch=function(e,t,i,r){var o=e[e.length-1].trim(),n=o.charAt(0);o=o.substring(1);var a=t.lastIndexOf(o),s=a+o.length;return log("cursorPos",i),i>=a&&i<=s&&o&&o.length>=r&&":"===n&&emojiUtils.addToPreviewList(emojiUtils.filterEmoji(o)),log("match",e,a,s),{start:a,end:s,currentMatch:o}},chatInputKeyupFunc=function(e){var t=document.querySelector("#autocomplete-preview"),i=t.children.length>0;if(e.keyCode!==KEYS.enter||i){if(e.keyCode===KEYS.up&&i)return e.preventDefault(),void previewList.doNavigate(-1);if(e.keyCode===KEYS.down&&i)return e.preventDefault(),void previewList.doNavigate(1);if((e.keyCode===KEYS.enter||e.keyCode===KEYS.tab)&&i)return e.preventDefault(),previewList.selected=$(".preview-item.selected").find(".ac-text").text(),previewList.updateChatInput(),!1;var r=e.target.value,o=e.target.selectionStart,n=r.match(inputRegex),a="";if(n&&n.length>0){var s=handleMatch(n,r,o,keyCharMin);a=s.currentMatch,previewList.data=s}log("inKeyup",previewList.data),shouldClearPreview(t,a,r,keyCharMin)}},chatInputKeydownFunc=function(e){var t=document.querySelector("#autocomplete-preview > li"),i=[KEYS.tab,KEYS.enter,KEYS.up,KEYS.down].includes(e.keyCode),r=e.shiftKey||e.ctrlKey||e.altKey||e.metaKey;!r&&t&&i?e.preventDefault():r||e.keyCode!==KEYS.enter?r||window.QueUp.room.chat.ncKeyDown(e):(window.QueUp.room.chat.sendMessage(),window.QueUp.room.chat.resizeTextarea())};myModule.turnOn=function(){previewList.init(),QueUp.room.chat.delegateEvents(_.omit(QueUp.room.chat.events,["keydown #chat-txt-message"])),$("#chat-txt-message").on("keydown",chatInputKeydownFunc),$("#chat-txt-message").on("keyup",chatInputKeyupFunc)},myModule.turnOff=function(){previewList.stop(),QueUp.room.chat.delegateEvents(QueUp.room.chat.events),$("#chat-txt-message").off("keydown",chatInputKeydownFunc),$("#chat-txt-message").off("keyup",chatInputKeyupFunc)},module.exports=myModule;
...
"use strict";var _api=require("../utils/api.js"),css=require("../utils/css.js"),myModule={id:"dubplus-comm-theme",moduleName:"Community Theme",description:"Toggle Community CSS theme.",category:"Customize",turnOn:function(){var e=QueUp.room.model.get("roomUrl");$.ajax({type:"GET",url:"".concat(_api.apiBase,"/room/").concat(e)}).done(function(e){var o=e.data.description,t=new RegExp(/(@dub(x|plus|\+)=)((https?:\/\/)?[\w-]+(\.[\w-]+)+\.?(:\d+)?(\/\S*)?)/,"i"),u=null;o.replace(t,function(e,o,t,m){console.log("loading community css theme:",m),u=m}),u&&css.loadExternal(u,"dubplus-comm-theme")})},turnOff:function(){$(".dubplus-comm-theme").remove()}};module.exports=myModule;

},{"../utils/api.js":40,"../utils/css.js":41}],15:[function(require,module,exports){
"use strict";var settings=require("../lib/settings.js"),modal=require("../utils/modal.js"),options=require("../utils/options.js"),myModule={id:"dubplus-custom-bg",moduleName:"Custom Background",description:"Add your own custom background.",category:"Customize",extraIcon:"pencil"},makeBGdiv=function(e){return'<div class="dubplus-custom-bg" style="background-image: url('.concat(e,');"></div>')},saveCustomBG=function(){var e=$(".dp-modal textarea").val();options.saveOption("custom","bg",e||""),settings.options[myModule.id]&&($(".dubplus-custom-bg").remove(),e&&$("body").append(makeBGdiv(e)))};myModule.extra=function(){modal.create({title:"Custom Background Image",content:"Enter the full URL of an image. We recommend using a .jpg file. Leave blank to remove the current background image",value:settings.custom.bg||"",placeholder:"https://example.com/big-image.jpg",maxlength:"500",confirmCallback:saveCustomBG})},myModule.turnOn=function(){settings.custom.bg?($(".dubplus-custom-bg").remove(),$("body").append(makeBGdiv(settings.custom.bg))):this.extra()},myModule.turnOff=function(){$(".dubplus-custom-bg").remove()},module.exports=myModule;
...
"use strict";function eta(){var e=document.querySelector(".player_sharing .eta_tooltip_t"),t=document.createElement("div");t.className="eta_tooltip dubplus-tooltip",t.style.cssText="min-width: 150px;position: absolute;font: 1rem/1.5 proxima-nova,sans-serif;display: block;left: -33px;cursor: pointer;border-radius: 1.5rem;padding: 8px 16px;background: #fff;font-weight: 700;font-size: 13.6px;text-transform: uppercase;color: #000;opacity: .8;text-align: center;z-index: 9;";var o=document.querySelector("#player-controller div.left ul li.infoContainer.display-block div.currentTime span.min"),n=document.querySelector(".queue-position"),i=document.querySelector(".queue-total");if(!o.textContent||!i.textContent)return t.textContent="No one is in the queue",void e.appendChild(t);if(!n.textContent)return t.textContent="You're not in the queue",void e.appendChild(t);var r=parseInt(o.textContent),u=4*parseInt(n.textContent)-4+r;t.textContent=u>=0?"ETA: ".concat(u," minute").concat(u>1?"s":""):"You're not in the queue",e.appendChild(t)}function hide_eta(){var e;null===(e=document.querySelector(".eta_tooltip"))||void 0===e||e.remove()}function _default(){document.querySelector(".player_sharing .eta_tooltip_t")&&document.querySelector(".player_sharing .eta_tooltip_t").remove(),window.dubplus.etaTooltipShow=eta,window.dubplus.etaTooltipHide=hide_eta;var e=document.createElement("span");e.className="icon-history eta_tooltip_t",e.style.position="relative",e.setAttribute("onmouseover","window.dubplus.etaTooltipShow()"),e.setAttribute("onmouseout","window.dubplus.etaTooltipHide()"),document.querySelector(".player_sharing").appendChild(e)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=_default;
...
"use strict";var _modcheck=_interopRequireDefault(require("../utils/modcheck.js")),_api=require("../utils/api.js");function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var modal=require("../utils/modal.js"),dubshover={id:"dubplus-dubs-hover",moduleName:"Show Dub info on Hover",description:"Show Dub info on Hover.",category:"General",resetGrabs:function(){window.dubplus.dubs.grabs=[]},grabInfoWarning:function(){this.warned&&(this.warned=!0,modal.create({title:"Grab Vote Info",content:"Please note that this feature is currently still in development. We are waiting on the ability to pull grab vote information from Dubtrack on load. Until then the only grabs you will be able to see are those you are present in the room for."}))},showDubsOnHover:function(){var e=this;this.resetDubs(),QueUp.Events.bind("realtime:room_playlist-dub",this.dubWatcher.bind(this)),QueUp.Events.bind("realtime:room_playlist-queue-update-grabs",this.grabWatcher.bind(this)),QueUp.Events.bind("realtime:user-leave",this.dubUserLeaveWatcher.bind(this)),QueUp.Events.bind("realtime:room_playlist-update",this.resetDubs.bind(this)),QueUp.Events.bind("realtime:room_playlist-update",this.resetGrabs.bind(this));var u=$(".dubup").first().parent("li"),s=$(".dubdown").first().parent("li"),n=$(".add-to-playlist-button").first().parent("li");$(u).addClass("dubplus-updubs-hover"),$(s).addClass("dubplus-downdubs-hover"),$(n).addClass("dubplus-grabs-hover"),$(u).click(function(e){$("#dubplus-updubs-container").remove();var s=e.clientX,n=e.clientY;if(!s||!n||isNaN(s)||isNaN(n))return $("#dubplus-downdubs-container").remove();var d=document.elementFromPoint(s,n);($(d).hasClass("dubplus-updubs-hover")||$(d).parents(".dubplus-updubs-hover").length>0)&&setTimeout(function(){$(u).mouseenter()},250)}),$(s).click(function(e){$("#dubplus-downdubs-container").remove();var u=e.clientX,n=e.clientY;if(!u||!n||isNaN(u)||isNaN(n))return $("#dubplus-downdubs-container").remove();var d=document.elementFromPoint(u,n);($(d).hasClass("dubplus-downdubs-hover")||$(d).parents(".dubplus-downdubs-hover").length>0)&&setTimeout(function(){$(s).mouseenter()},250)}),$(n).click(function(e){$("#dubplus-grabs-container").remove();var u=e.clientX,s=e.clientY;if(!u||!s||isNaN(u)||isNaN(s))return $("#dubplus-grabs-container").remove();var d=document.elementFromPoint(u,s);($(d).hasClass("dubplus-grabs-hover")||$(d).parents(".dubplus-grabs-hover").length>0)&&setTimeout(function(){$(n).mouseenter()},250)}),$(u).mouseenter(function(n){var d=n.currentTarget;if(!($("#dubplus-updubs-container").length>0)){var i,t=$(u).innerWidth()+$(s).innerWidth(),r=$(".dubup").hasClass("voted")?$(".dubup").css("background-color"):$(".dubup").find(".icon-arrow-up").css("color");window.dubplus.dubs.upDubs.length>0?(i='<ul id="dubinfo-preview" class="dubinfo-show dubplus-updubs-hover" style="border-color: '.concat(r,'">'),window.dubplus.dubs.upDubs.forEach(function(e){i+='\n          <li class="preview-dubinfo-item users-previews dubplus-updubs-hover">\n            <div class="dubinfo-image">\n              <img src="'.concat(_api.apiBase,"/user/").concat(e.userid,'/image">\n            </div>\n            <span class="dubinfo-text">@').concat(e.username,"</span>\n          </li>\n        ")}),i+="</ul>"):i='<div id="dubinfo-preview" class="dubinfo-show dubplus-updubs-hover dubplus-no-dubs" style="border-color: '.concat(r,'">\n          No updubs have been casted yet!\n        </div>');var o=document.createElement("div");o.id="dubplus-updubs-container",o.className="dubinfo-show dubplus-updubs-hover",o.innerHTML=i,o.style.visibility="hidden",document.body.appendChild(o);var a=d.getBoundingClientRect(),b=document.body.getBoundingClientRect();o.style.visibility="",o.style.width=t+"px",o.style.top=a.top-150+"px",b.right-a.left>=t?o.style.left=a.left+"px":o.style.right=0,document.body.appendChild(o),$(d).addClass("dubplus-updubs-hover"),$(document.body).on("click",".preview-dubinfo-item",function(u){var s=$(u.currentTarget).find(".dubinfo-text")[0].innerHTML+" ";e.updateChatInputWithString(s)}),$(".dubplus-updubs-hover").mouseleave(function(e){var u=e.clientX,s=e.clientY;if(!u||!s||isNaN(u)||isNaN(s))return $("#dubplus-downdubs-container").remove();var n=document.elementFromPoint(u,s);!$(n).hasClass("dubplus-updubs-hover")&&!$(n).hasClass("ps-scrollbar-y")&&$(n).parent(".dubplus-updubs-hover").length<=0&&$("#dubplus-updubs-container").remove()})}}),$(s).mouseenter(function(n){var d=n.currentTarget;if(!($("#dubplus-downdubs-container").length>0)){var i,t=$(u).innerWidth()+$(s).innerWidth(),r=$(".dubdown").hasClass("voted")?$(".dubdown").css("background-color"):$(".dubdown").find(".icon-arrow-down").css("color");(0,_modcheck.default)(QueUp.session.id)?window.dubplus.dubs.downDubs.length>0?(i='<ul id="dubinfo-preview" class="dubinfo-show dubplus-downdubs-hover" style="border-color: '.concat(r,'">'),window.dubplus.dubs.downDubs.forEach(function(e){i+='\n            <li class="preview-dubinfo-item users-previews dubplus-downdubs-hover">\n              <div class="dubinfo-image">\n                <img src="'.concat(_api.apiBase,"/user/").concat(e.userid,'/image" />\n              </div>\n              <span class="dubinfo-text">@').concat(e.username,"</span>\n            </li>\n          ")}),i+="</ul>"):i='<div id="dubinfo-preview" class="dubinfo-show dubplus-downdubs-hover dubplus-no-dubs" style="border-color: '.concat(r,'">\n          No downdubs have been casted yet!\n          </div>'):i='<div id="dubinfo-preview" class="dubinfo-show dubplus-downdubs-hover dubplus-downdubs-unauthorized" style="border-color: '.concat(r,'">\n          You must be at least a mod to view downdubs!\n        </div>');var o=document.createElement("div");o.id="dubplus-downdubs-container",o.className="dubinfo-show dubplus-downdubs-hover",o.innerHTML=i,o.style.visibility="hidden",document.body.appendChild(o);var a=d.getBoundingClientRect(),b=document.body.getBoundingClientRect();o.style.visibility="",o.style.width=t+"px",o.style.top=a.top-150+"px",b.right-a.left>=t?o.style.left=a.left+"px":o.style.right=0,document.body.appendChild(o),$(d).addClass("dubplus-downdubs-hover"),$(document.body).on("click",".preview-dubinfo-item",function(u){var s=$(u.currentTarget).find(".dubinfo-text")[0].innerHTML+" ";e.updateChatInputWithString(s)}),$(".dubplus-downdubs-hover").mouseleave(function(e){var u=e.clientX,s=e.clientY;if(!u||!s||isNaN(u)||isNaN(s))return $("#dubplus-downdubs-container").remove();var n=document.elementFromPoint(u,s);!$(n).hasClass("dubplus-downdubs-hover")&&!$(n).hasClass("ps-scrollbar-y")&&$(n).parent(".dubplus-downdubs-hover").length<=0&&$("#dubplus-downdubs-container").remove()})}}),$(n).mouseenter(function(s){var d=s.currentTarget;if(!($("#dubplus-grabs-container").length>0)){var i,t=$(u).innerWidth()+$(n).innerWidth(),r=$(".add-to-playlist-button").hasClass("grabbed")?$(".add-to-playlist-button").css("background-color"):$(".add-to-playlist-button").find(".icon-heart").css("color");window.dubplus.dubs.grabs.length>0?(i='<ul id="dubinfo-preview" class="dubinfo-show dubplus-grabs-hover" style="border-color: '+r+'">',window.dubplus.dubs.grabs.forEach(function(e){i+='<li class="preview-dubinfo-item users-previews dubplus-grabs-hover"><div class="dubinfo-image">'+'<img src="'.concat(_api.apiBase,"/user/").concat(e.userid,'/image" />')+'</div><span class="dubinfo-text">@'+e.username+"</span></li>"}),i+="</ul>"):i='<div id="dubinfo-preview" class="dubinfo-show dubplus-grabs-hover dubplus-no-grabs" style="border-color: '+r+"\">This song hasn't been grabbed yet!</div>";var o=document.createElement("div");o.id="dubplus-grabs-container",o.className="dubinfo-show dubplus-grabs-hover",o.innerHTML=i,o.style.visibility="hidden",document.body.appendChild(o);var a=d.getBoundingClientRect(),b=document.body.getBoundingClientRect();o.style.visibility="",o.style.width=t+"px",o.style.top=a.top-150+"px",b.right-a.left>=t?o.style.left=a.left+"px":o.style.right=0,document.body.appendChild(o),$(d).addClass("dubplus-grabs-hover"),$(document.body).on("click",".preview-dubinfo-item",function(u){var s=$(u.currentTarget).find(".dubinfo-text")[0].innerHTML+" ";e.updateChatInputWithString(s)}),$(".dubplus-grabs-hover").mouseleave(function(e){var u=e.clientX,s=e.clientY;if(!u||!s||isNaN(u)||isNaN(s))return $("#dubplus-grabs-container").remove();var n=document.elementFromPoint(u,s);!$(n).hasClass("dubplus-grabs-hover")&&!$(n).hasClass("ps-scrollbar-y")&&$(n).parent(".dubplus-grabs-hover").length<=0&&$("#dubplus-grabs-container").remove()})}})},stopDubsOnHover:function(){QueUp.Events.unbind("realtime:room_playlist-dub",this.dubWatcher),QueUp.Events.unbind("realtime:room_playlist-queue-update-grabs",this.grabWatcher),QueUp.Events.unbind("realtime:user-leave",this.dubUserLeaveWatcher),QueUp.Events.unbind("realtime:room_playlist-update",this.resetDubs),QueUp.Events.unbind("realtime:room_playlist-update",this.resetGrabs)},dubUserLeaveWatcher:function(e){$.grep(window.dubplus.dubs.upDubs,function(u){return u.userid===e.user._id}).length>0&&$.each(window.dubplus.dubs.upDubs,function(u){if(window.dubplus.dubs.upDubs[u].userid===e.user._id)return window.dubplus.dubs.upDubs.splice(u,1),!1}),$.grep(window.dubplus.dubs.downDubs,function(u){return u.userid===e.user._id}).length>0&&$.each(window.dubplus.dubs.downDubs,function(u){if(window.dubplus.dubs.downDubs[u].userid===e.user._id)return window.dubplus.dubs.downDubs.splice(u,1),!1}),$.grep(window.dubplus.dubs.grabs,function(u){return u.userid===e.user._id}).length>0&&$.each(window.dubplus.dubs.grabs,function(u){if(window.dubplus.dubs.grabs[u].userid===e.user._id)return window.dubplus.dubs.grabs.splice(u,1),!1})},grabWatcher:function(e){$.grep(window.dubplus.dubs.grabs,function(u){return u.userid===e.user._id}).length<=0&&window.dubplus.dubs.grabs.push({userid:e.user._id,username:e.user.username})},updateChatInputWithString:function(e){$("#chat-txt-message").val(e).focus()},deleteChatMessageClientSide:function(e){$(e).parent("li")[0].remove()},dubWatcher:function(e){"updub"===e.dubtype?($.grep(window.dubplus.dubs.upDubs,function(u){return u.userid===e.user._id}).length<=0&&window.dubplus.dubs.upDubs.push({userid:e.user._id,username:e.user.username}),$.grep(window.dubplus.dubs.downDubs,function(u){return u.userid===e.user._id}).length>0&&$.each(window.dubplus.dubs.downDubs,function(u){if(window.dubplus.dubs.downDubs[u].userid===e.user._id)return window.dubplus.dubs.downDubs.splice(u,1),!1})):"downdub"===e.dubtype&&($.grep(window.dubplus.dubs.downDubs,function(u){return u.userid===e.user._id}).length<=0&&(0,_modcheck.default)(QueUp.session.id)&&window.dubplus.dubs.downDubs.push({userid:e.user._id,username:e.user.username}),$.grep(window.dubplus.dubs.upDubs,function(u){return u.userid===e.user._id}).length>0&&$.each(window.dubplus.dubs.upDubs,function(u){if(window.dubplus.dubs.upDubs[u].userid===e.user._id)return window.dubplus.dubs.upDubs.splice(u,1),!1})),new Date-new Date(QueUp.room.player.activeSong.attributes.song.played)<1e3||(window.dubplus.dubs.upDubs.length!==QueUp.room.player.activeSong.attributes.song.updubs?this.resetDubs():(0,_modcheck.default)(QueUp.session.id)&&window.dubplus.dubs.downDubs.length!==QueUp.room.player.activeSong.attributes.song.downdubs&&this.resetDubs())},resetDubs:function(){window.dubplus.dubs.upDubs=[],window.dubplus.dubs.downDubs=[];var e="".concat(_api.apiBase,"/room/").concat(QueUp.room.model.id,"/playlist/active/dubs");$.getJSON(e,function(e){e.data.upDubs.forEach(function(e){var u;$.grep(window.dubplus.dubs.upDubs,function(u){return u.userid===e.userid}).length>0||(QueUp.room.users.collection.findWhere({userid:e.userid})&&QueUp.room.users.collection.findWhere({userid:e.userid}).attributes?u=QueUp.room.users.collection.findWhere({userid:e.userid}).attributes._user.username:$.getJSON("".concat(_api.apiBase,"/user/").concat(e.userid),function(e){e&&e.userinfo&&(u=e.userinfo.username)}),u&&window.dubplus.dubs.upDubs.push({userid:e.userid,username:u}))}),(0,_modcheck.default)(QueUp.session.id)&&e.data.downDubs.forEach(function(e){$.grep(window.dubplus.dubs.downDubs,function(u){return u.userid===e.userid}).length>0||(QueUp.room.users.collection.findWhere({userid:e.userid})&&QueUp.room.users.collection.findWhere({userid:e.userid}).attributes?QueUp.room.users.collection.findWhere({userid:e.userid}).attributes._user.username:$.getJSON("".concat(_api.apiBase,"/user/").concat(e.userid),function(e){e.userinfo.username}),window.dubplus.dubs.downDubs.push({userid:e.userid,username:QueUp.room.users.collection.findWhere({userid:e.userid}).attributes._user.username}))})})},init:function(){window.dubplus.dubs={upDubs:[],downDubs:[],grabs:[]}},turnOn:function(){this.grabInfoWarning(),this.showDubsOnHover()},turnOff:function(){this.stopDubsOnHover()}};module.exports=dubshover;
...
"use strict";function snooze_tooltip(){var e=document.createElement("div");e.className="snooze_tooltip",e.style.cssText="min-width: 186px;position: absolute;font: 1rem/1.5 proxima-nova,sans-serif;display: block;left: -15px;cursor: pointer;border-radius: 1.5rem;padding: 8px 16px;background: #fff;font-weight: 700;font-size: 13.6px;text-transform: uppercase;color: #000;opacity: .8;text-align: center;z-index: 9",e.textContent="Mute current song",document.querySelector(".player_sharing .snooze_btn").appendChild(e)}function hide_snooze_tooltip(){var e;null===(e=document.querySelector(".snooze_tooltip"))||void 0===e||e.remove()}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=_default;var eventUtils={currentVol:50,snoozed:!1};function eventSongAdvance(e){if(e.startTime<2)return eventUtils.snoozed&&(QueUp.room.player.setVolume(eventUtils.currentVol),eventUtils.snoozed=!1),!0}function snooze(){!eventUtils.snoozed&&!QueUp.room.player.muted_player&&QueUp.playerController.volume>2?(eventUtils.currentVol=QueUp.playerController.volume,QueUp.room.player.mutePlayer(),eventUtils.snoozed=!0,QueUp.Events.bind("realtime:room_playlist-update",eventSongAdvance)):eventUtils.snoozed&&(QueUp.room.player.setVolume(eventUtils.currentVol),QueUp.room.player.updateVolumeBar(),eventUtils.snoozed=!1)}function _default(){document.querySelector(".player_sharing .snooze_btn")&&document.querySelector(".player_sharing .snooze_btn").remove(),window.dubplus.snowTooltipShow=snooze_tooltip,window.dubplus.snoozeTooltipHide=hide_snooze_tooltip,window.dubplus.snoozeClick=snooze;var e=document.createElement("span");e.className="icon-mute snooze_btn",e.style.position="relative",e.setAttribute("onmouseover","window.dubplus.snowTooltipShow()"),e.setAttribute("onmouseout","window.dubplus.snoozeTooltipHide()"),e.setAttribute("onclick","window.dubplus.snoozeClick()"),document.querySelector(".player_sharing").appendChild(e)}
...
"use strict";var myModule={id:"dubplus-spacebar-mute",moduleName:"Spacebar Mute",description:"Turn on/off the ability to mute current song with the spacebar.",category:"Settings"},clickableTags=["input","textarea","button","select","a"];function onSpacebar(e){var t=e.target.tagName.toLowerCase();32!==e.which||clickableTags.includes(t)||e.target.isContentEditable||QueUp.room.player.mutePlayer()}myModule.turnOn=function(){$(document).on("keypress.key32",onSpacebar)},myModule.turnOff=function(){$(document).off("keypress.key32",onSpacebar)},module.exports=myModule;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.apiBase=void 0;var apiBase=exports.apiBase=window.location.hostname.includes("staging")?"https://staging-api.queup.dev":"https://api.queup.net";

},{}],41:[function(require,module,exports){
(function (TIME_STAMP){(function (){
"use strict";var settings=require("../lib/settings.js"),makeLink=function(e,n){var t=document.createElement("link");return t.rel="stylesheet",t.type="text/css",t.className=e||"",t.href=n,t};function removeLink(e){var n=document.querySelector("link.".concat(e));n&&n.remove()}var load=function(e,n){if(e){removeLink(n);var t=makeLink(n,settings.srcRoot+e+"?"+TIME_STAMP);document.head.appendChild(t)}},loadExternal=function(e,n){if(e){removeLink(n);var t=makeLink(n,e);document.head.appendChild(t)}};module.exports={load:load,loadExternal:loadExternal};

}).call(this)}).call(this,'1720194289813')
