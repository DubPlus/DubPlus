...
'use strict';var GetJSON=require('../utils/getJSON.js'),settings=require('../lib/settings.js'),prepEmoji={};prepEmoji.emoji={template:function(b){return emojify.defaultConfig.img_dir+'/'+encodeURI(b)+'.png'}},prepEmoji.twitch={template:function(b){return'//static-cdn.jtvnw.net/emoticons/v1/'+b+'/3.0'},specialEmotes:[],emotes:{},chatRegex:/:([-_a-z0-9]+):/ig},prepEmoji.bttv={template:function(b){return'//cdn.betterttv.net/emote/'+b+'/3x'},emotes:{},chatRegex:/:([&!()\-_a-z0-9]+):/ig},prepEmoji.tasty={template:function(b){return this.emotes[b].url},emotes:{}},prepEmoji.shouldUpdateAPIs=function(a){var c=localStorage.getItem(a+'_api');if(c){var d=JSON.parse(c);if('undefined'!=typeof d.error)return!0}var e=Date.now(),f=parseInt(localStorage.getItem(a+'_api_timestamp'));return isNaN(f)||e-f>5*8.64e7||!c},prepEmoji.loadTwitchEmotes=function(){var a=this,b;if(this.shouldUpdateAPIs('twitch')){console.log('dub+','twitch','loading from api');var c=new GetJSON('https://api.twitch.tv/kraken/chat/emoticon_images','twitch:loaded',{'Client-ID':'5vhafslpr2yqal6715puzysmzrntmt8'});c.done(function(e){localStorage.setItem('twitch_api_timestamp',Date.now().toString()),localStorage.setItem('twitch_api',e),a.processTwitchEmotes(JSON.parse(e))})}else{console.log('dub+','twitch','loading from localstorage'),b=JSON.parse(localStorage.getItem('twitch_api')),this.processTwitchEmotes(b),b=null;var d=new Event('twitch:loaded');window.dispatchEvent(d)}},prepEmoji.loadBTTVEmotes=function(){var a=this,b;if(this.shouldUpdateAPIs('bttv')){console.log('dub+','bttv','loading from api');var c=new GetJSON('//api.betterttv.net/2/emotes','bttv:loaded');c.done(function(e){localStorage.setItem('bttv_api_timestamp',Date.now().toString()),localStorage.setItem('bttv_api',e),a.processBTTVEmotes(JSON.parse(e))})}else{console.log('dub+','bttv','loading from localstorage'),b=JSON.parse(localStorage.getItem('bttv_api')),this.processBTTVEmotes(b),b=null;var d=new Event('bttv:loaded');window.dispatchEvent(d)}},prepEmoji.loadTastyEmotes=function(){var a=this;console.log('dub+','tasty','loading from api');var b=new GetJSON(settings.srcRoot+'/emotes/tastyemotes.json','tasty:loaded');b.done(function(c){localStorage.setItem('tasty_api',c),a.processTastyEmotes(JSON.parse(c))})},prepEmoji.processTwitchEmotes=function(a){var b=this;a.emoticons.forEach(function(c){var d=c.code.toLowerCase();return 0<=c.code.indexOf('\\')?void b.twitch.specialEmotes.push([c.code,c.id]):void(0<=emojify.emojiNames.indexOf(d)||(b.twitch.emotes[d]?null===c.emoticon_set&&(b.twitch.emotes[d]=c.id):b.twitch.emotes[d]=c.id))}),this.twitchJSONSLoaded=!0,this.emojiEmotes=emojify.emojiNames.concat(Object.keys(this.twitch.emotes))},prepEmoji.processBTTVEmotes=function(a){var b=this;a.emotes.forEach(function(c){var d=c.code.toLowerCase();0<=c.code.indexOf(':')||0<=emojify.emojiNames.indexOf(d)||(0<=c.code.indexOf('(')&&(d=d.replace(/([()])/g,'')),b.bttv.emotes[d]=c.id)}),this.bttvJSONSLoaded=!0,this.emojiEmotes=this.emojiEmotes.concat(Object.keys(this.bttv.emotes))},prepEmoji.processTastyEmotes=function(a){this.tasty.emotes=a.emotes,this.tastyJSONLoaded=!0,this.emojiEmotes=this.emojiEmotes.concat(Object.keys(this.tasty.emotes))},module.exports=prepEmoji;

},{"../lib/settings.js":8,"../utils/getJSON.js":41}],3:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function a(b,c){for(var g,f=0;f<c.length;f++)g=c[f],g.enumerable=g.enumerable||!1,g.configurable=!0,"value"in g&&(g.writable=!0),Object.defineProperty(b,g.key,g)}return function(b,c,f){return c&&a(b.prototype,c),f&&a(b,f),b}}();function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}var debugAC=!1;function log(){}var makeList=function(b){function c(m){var n=document.createElement("li");return n.className=m,n}function f(m,n){var o=document.createElement("img");o.src=m,n&&(o.title=n,o.alt=n);var p=document.createElement("div");return p.className="ac-image",p.appendChild(o),p}function g(m){var n=document.createElement("span");return n.textContent=m,n.className="ac-text",n}function h(){var m=document.createElement("span");return m.textContent="press enter to select",m.className="ac-list-press-enter",m}function j(m,n){var q,o=c("preview-item "+m.cn+"-previews"),p=g(m.text);return q=m.alt?f(m.src,m.alt):f(m.src),o.appendChild(q),o.appendChild(p),0===n&&(o.appendChild(h()),o.classList.add("selected")),o.tabIndex=-1,o}var k=document.getElementById("autocomplete-preview");k.innerHTML="";var l=document.createDocumentFragment();b.forEach(function(m,n){l.appendChild(j(m,n))}),k.appendChild(l),k.classList.add("ac-show")};function isElementInView(a,b){var c=a.getBoundingClientRect(),f=b.getBoundingClientRect();return c.top>=f.top&&c.bottom<=f.bottom}var PreviewListManager=function(){function a(b){_classCallCheck(this,a),this._data=b||{start:0,end:0,selected:""}}return _createClass(a,[{key:"repl",value:function(c,f,g,h){return c.substring(0,f-1)+h+c.substring(g)}},{key:"updateChatInput",value:function(){log("inUpdate",this._data);var c=$("#chat-txt-message").val(),f=this.repl(c,this._data.start,this._data.end,this._data.selected)+" ";$("#autocomplete-preview").empty().removeClass("ac-show"),$("#chat-txt-message").val(f).focus()}},{key:"doNavigate",value:function(c){var f=$(".preview-item.selected").index();f+=c;var g=$(".ac-show li");$(".ac-list-press-enter").remove(),f>=g.length&&(f=0),0>f&&(f=g.length-1);var h="selected";g.removeClass(h).eq(f).addClass(h).append("<span class=\"ac-list-press-enter\">press enter or tab to select</span>");var k=document.querySelector(".preview-item.selected"),l=document.querySelector("#autocomplete-preview"),m=isElementInView(k,l);log("isInView",m);m||k.scrollIntoView(1!==c)}},{key:"updater",value:function(c){log(c.target,c),this._data.selected=$(c.target).find(".ac-text").text(),this.updateChatInput()}},{key:"init",value:function(){var c=this,f=document.createElement("ul");f.id="autocomplete-preview",$(".pusher-chat-widget-input").prepend(f),$(document.body).on("click",".preview-item",function(g){return c.updater(g)})}},{key:"stop",value:function(){$("#autocomplete-preview").remove()}},{key:"data",get:function(){return this._data},set:function(c){c&&(this._data=c)}},{key:"selected",set:function(c){c&&(this._data.selected=c)}}]),a}();exports.PreviewListManager=PreviewListManager,exports.makeList=makeList;
...
'use strict';Object.defineProperty(exports,'__esModule',{value:!0});var options=require('../utils/options.js'),dubPlus_modules=require('../modules/index.js'),settings=require('../lib/settings.js'),menu=require('../lib/menu.js'),menuObj={General:'','User Interface':'',Settings:'',Customize:''},loadAllModules=function(){return dubPlus_modules.forEach(function(b){window.dubplus[b.id]=b,window.dubplus[b.id].toggleAndSave=options.toggleAndSave,b.optionState=settings.options[b.id]||!1,'function'==typeof b.init&&b.init.call(b),b.optionState&&'function'==typeof b.turnOn&&b.turnOn.call(b);var c=null;'function'!=typeof b.extra||b.extraIcon||(c='pencil'),menuObj[b.category]+=menu.makeOptionMenu(b.moduleName,{id:b.id,desc:b.description,state:b.optionState,extraIcon:b.extraIcon||c,cssClass:b.menuCssClass||'',altIcon:b.altIcon||null})}),menuObj};exports.default=loadAllModules;

},{"../lib/menu.js":7,"../lib/settings.js":8,"../modules/index.js":29,"../utils/options.js":45}],6:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var options=require("../utils/options.js"),toggleMenuSection=function(b){var c=b.nextElementSibling,d=b.children[0],e=b.textContent.trim().replace(" ","-").toLowerCase(),f="dubplus-menu-section-closed",g=$(c).toggleClass(f).hasClass(f);g?($(d).removeClass("fa-angle-down"),$(d).addClass("fa-angle-right"),options.saveOption("menu",e,"closed")):($(d).removeClass("fa-angle-right"),$(d).addClass("fa-angle-down"),options.saveOption("menu",e,"open"))},traverseMenuDOM=function a(b){if(!b||$(b).hasClass("dubplus-menu"))return null;if($(b).hasClass("dubplus-menu-section-header"))return toggleMenuSection(b),null;var c=window.dubplus[b.id];return c?c:a(b.parentElement)},menuDelegator=function(b){var c=traverseMenuDOM(b.target);if(c){if($(b.target).hasClass("extra-icon")&&c.extra)return void c.extra.call(c);if(c.turnOn&&c.turnOff){var d;return c.optionState?(d=!1,c.turnOff.call(c)):(d=!0,c.turnOn.call(c)),c.optionState=d,void options.toggleAndSave(c.id,d)}c.go&&c.go.call(c)}};exports.default=function(){var a=document.querySelector(".dubplus-menu");a.addEventListener("click",menuDelegator),document.querySelector(".dubplus-icon").addEventListener("click",function(){$(a).toggleClass("dubplus-menu-open")})};

},{"../utils/options.js":45}],7:[function(require,module,exports){
'use strict';var _menuEvents=require('./menu-events.js'),_menuEvents2=_interopRequireDefault(_menuEvents);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}var settings=require('./settings.js'),css=require('../utils/css.js'),arrow='down',isClosedClass='';'closed'===settings.menu.contact&&(isClosedClass='dubplus-menu-section-closed',arrow='right');var contactSection='\n  <div id="dubplus-contact" class="dubplus-menu-section-header">\n      <span class="fa fa-angle-'+arrow+'"></span>\n      <p>Contact</p>\n    </div>\n    <ul class="dubplus-menu-section '+isClosedClass+'">\n      <li class="dubplus-menu-icon">\n        <span class="fa fa-bug"></span>\n        <a href="https://discord.gg/XUkG3Qy" class="dubplus-menu-label" target="_blank">Report bugs on Discord</a>\n      </li>\n      <li class="dubplus-menu-icon">\n        <span class="fa fa-reddit-alien"></span>\n        <a href="https://www.reddit.com/r/DubPlus/" class="dubplus-menu-label"  target="_blank">Reddit</a>\n      </li>\n      <li class="dubplus-menu-icon">\n        <span class="fa fa-facebook"></span>\n        <a href="https://facebook.com/DubPlusScript" class="dubplus-menu-label"  target="_blank">Facebook</a>\n      </li>\n      <li class="dubplus-menu-icon">\n        <span class="fa fa-twitter"></span>\n        <a href="https://twitter.com/DubPlusScript" class="dubplus-menu-label"  target="_blank">Twitter</a>\n      </li>\n    </ul>';module.exports={beginMenu:function(){css.loadExternal('https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css');var b='<div class="dubplus-icon"><img src="'+settings.srcRoot+'/images/dubplus.svg" alt=""></div>';document.querySelector('.header-right-navigation').insertAdjacentHTML('beforeend',b);return'\n      <section class="dubplus-menu">\n          <p class="dubplus-menu-header">Dub+ Options</p>'},finishMenu:function(b,c){for(var d in b){var e=d.replace(' ','-').toLowerCase(),f=settings.menu[e],h='down',i='';'closed'===f&&(i='dubplus-menu-section-closed',h='right'),c+='\n        <div id="'+('dubplus-'+e)+'" class="dubplus-menu-section-header">\n          <span class="fa fa-angle-'+h+'"></span>\n          <p>'+d+'</p>\n        </div>\n        <ul class="dubplus-menu-section '+i+'">',c+=b[d],c+='</ul>'}c+=contactSection,c+='</section>',document.body.insertAdjacentHTML('beforeend',c),(0,_menuEvents2.default)()},makeOptionMenu:function(b,c){var e=Object.assign({},{id:'',desc:'',state:!1,extraIcon:null,cssClass:'',altIcon:null},c),f='',g=e.state?'dubplus-switch-on':'';e.extraIcon&&(f='<span class="fa fa-'+e.extraIcon+' extra-icon"></span>');var h='dubplus-switch',i='\n        <div class="dubplus-switch-bg">\n          <div class="dubplus-switcher"></div>\n        </div>';return e.altIcon&&(h='dubplus-menu-icon',i='<span class="fa fa-'+e.altIcon+'"></span>'),'\n      <li id="'+e.id+'" class="'+h+' '+g+' '+e.cssClass+' title="'+e.desc+'">\n        '+f+'\n        '+i+'\n        <span class="dubplus-menu-label">'+b+'</span>\n      </li>'}};
...
'use strict';var modal=require('../utils/modal.js'),options=require('../utils/options.js'),settings=require('../lib/settings.js'),afk_module={};afk_module.id='dubplus-afk',afk_module.moduleName='AFK Auto-respond',afk_module.description='Toggle Away from Keyboard and customize AFK message.',afk_module.category='General';var afk_chat_respond=function(b){var c=b.message,d=Dubtrack.session.get('username');if(-1<c.indexOf('@'+d)&&Dubtrack.session.id!==b.user.userInfo.userid){settings.custom.customAfkMessage?$('#chat-txt-message').val('[AFK] '+settings.custom.customAfkMessage):$('#chat-txt-message').val('[AFK] I\'m not here right now.'),Dubtrack.room.chat.sendMessage(),this.optionState=!1;var f=this;setTimeout(function(){f.optionState=!0},1.8e5)}};afk_module.turnOn=function(){Dubtrack.Events.bind('realtime:chat-message',afk_chat_respond)},afk_module.turnOff=function(){Dubtrack.Events.unbind('realtime:chat-message',afk_chat_respond)};var saveAFKmessage=function(){var b=$('.dp-modal textarea').val();''!==b&&options.saveOption('custom','customAfkMessage',b)};afk_module.extra=function(){modal.create({title:'Custom AFK Message',content:'Enter a custom Away From Keyboard [AFK] message here',value:settings.custom.customAfkMessage||'',placeholder:'Be right back!',maxlength:'255',confirmCallback:saveAFKmessage})},module.exports=afk_module;

},{"../lib/settings.js":8,"../utils/modal.js":42,"../utils/options.js":45}],10:[function(require,module,exports){
'use strict';var _previewList=require('../emojiUtils/previewList.js'),settings=require('../lib/settings.js'),prepEmjoji=require('../emojiUtils/prepEmoji.js'),debugAC=!1;function log(){}var myModule={id:'dubplus-autocomplete',moduleName:'Autocomplete Emoji',description:'Toggle autocompleting emojis and emotes.  Shows a preview box in the chat',category:'General'},KEYS={up:38,down:40,left:37,right:39,enter:13,esc:27,tab:9,shiftKey:16,backspace:8,del:46,space:32,ctrl:17},keyCharMin=3,inputRegex=/(:)([&!()\+\-_a-z0-9]+)($|\s)/ig,emojiUtils={createPreviewObj:function(b,c,d){return{src:prepEmjoji[b].template(c),text:':'+d+':',alt:d,cn:b}},addToPreviewList:function(b){var c=this,d=[],f;b.forEach(function(g){f=g.toLowerCase(),'undefined'!=typeof prepEmjoji.twitch.emotes[f]&&d.push(c.createPreviewObj('twitch',prepEmjoji.twitch.emotes[f],g)),'undefined'!=typeof prepEmjoji.bttv.emotes[f]&&d.push(c.createPreviewObj('bttv',prepEmjoji.bttv.emotes[f],g)),'undefined'!=typeof prepEmjoji.tasty.emotes[f]&&d.push(c.createPreviewObj('tasty',f,g)),0<=emojify.emojiNames.indexOf(f)&&d.push(c.createPreviewObj('emoji',g,g))}),(0,_previewList.makeList)(d)},filterEmoji:function(b){var c=b.replace(/([+()])/,'\\$1'),d=new RegExp('^'+c,'i'),f=emojify.emojiNames;return settings.options['dubplus-emotes']&&(f=prepEmjoji.emojiEmotes),f.filter(function(g){return d.test(g)})}},previewList=new _previewList.PreviewListManager,shouldClearPreview=function(b,c,d,f){var g=d.charAt(d.length-1);return(c.length<f||':'===g||' '===g||''===d)&&(c='',b.innerHTML='',b.className=''),c},handleMatch=function(b,c,d,f){var g=b.length-1,h=b[g].trim(),i=h.charAt(0);h=h.substring(1);var j=c.lastIndexOf(h),k=j+h.length;return log('cursorPos',d),d>=j&&d<=k&&h&&h.length>=f&&':'===i&&emojiUtils.addToPreviewList(emojiUtils.filterEmoji(h)),log('match',b,j,k),{start:j,end:k,currentMatch:h}},chatInputKeyupFunc=function(b){var c=document.querySelector('#autocomplete-preview'),d=0<c.children.length;if(b.keyCode!==KEYS.enter||d){if(b.keyCode===KEYS.up&&d)return b.preventDefault(),void previewList.doNavigate(-1);if(b.keyCode===KEYS.down&&d)return b.preventDefault(),void previewList.doNavigate(1);if((b.keyCode===KEYS.enter||b.keyCode===KEYS.tab)&&d)return b.preventDefault(),previewList.selected=$('.preview-item.selected').find('.ac-text').text(),previewList.updateChatInput(),!1;var f=this.value,g=$(this).get(0).selectionStart,h=f.match(inputRegex),i='';if(h&&0<h.length){var j=handleMatch(h,f,g,keyCharMin);i=j.currentMatch,previewList.data=j}log('inKeyup',previewList.data),shouldClearPreview(c,i,f,keyCharMin)}},chatInputKeydownFunc=function(b){var c=0>=document.querySelector('#autocomplete-preview').children.length,d=_.includes([KEYS.tab,KEYS.enter,KEYS.up,KEYS.down,KEYS.left,KEYS.right],b.keyCode);return d&&c?Dubtrack.room.chat.ncKeyDown({which:b.keyCode}):void(d&&!c&&b.preventDefault())};myModule.turnOn=function(){previewList.init(),Dubtrack.room.chat.delegateEvents(_.omit(Dubtrack.room.chat.events,['keydown #chat-txt-message'])),$(document.body).on('keydown','#chat-txt-message',chatInputKeydownFunc),$(document.body).on('keyup','#chat-txt-message',chatInputKeyupFunc)},myModule.turnOff=function(){previewList.stop(),Dubtrack.room.chat.delegateEvents(Dubtrack.room.chat.events),$(document.body).off('keydown','#chat-txt-message',chatInputKeydownFunc),$(document.body).off('keyup','#chat-txt-message',chatInputKeyupFunc)},module.exports=myModule;

},{"../emojiUtils/prepEmoji.js":2,"../emojiUtils/previewList.js":3,"../lib/settings.js":8}],11:[function(require,module,exports){
"use strict";var autovote={id:"dubplus-autovote",moduleName:"Autovote",description:"Toggles auto upvoting for every song",category:"General"},advance_vote=function(){$(".dubup").click()},voteCheck=function(b){2>b.startTime&&advance_vote()};autovote.turnOff=function(){Dubtrack.Events.unbind("realtime:room_playlist-update",voteCheck)},autovote.turnOn=function(){var a=Dubtrack.room.player.activeSong.get("song"),b=Dubtrack.helpers.cookie.get("dub-"+Dubtrack.room.model.get("_id")),c=Dubtrack.helpers.cookie.get("dub-song");Dubtrack.room&&a&&a.songid===c||(b=!1),$(".dubup, .dubdown").hasClass("voted")||b||advance_vote(),Dubtrack.Events.bind("realtime:room_playlist-update",voteCheck)},module.exports=autovote;

},{}],12:[function(require,module,exports){
'use strict';var settings=require('../lib/settings.js'),modal=require('../utils/modal.js'),options=require('../utils/options.js'),myModule={};myModule.id='chat-cleaner',myModule.moduleName='Chat Cleaner',myModule.description='Automatically only keep a designated chatItems of chat items while clearing older ones, keeping CPU stress down',myModule.category='General',myModule.extraIcon='pencil';var saveAmount=function(){var b=parseInt($('.dp-modal textarea').val());isNaN(b)?options.saveOption('custom','chat_cleaner',500):options.saveOption('custom','chat_cleaner',b)};myModule.chatCleanerCheck=function(){var b=$('ul.chat-main > li').length;isNaN(b)||isNaN(settings.custom.chat_cleaner)||b<settings.custom.chat_cleaner||($('ul.chat-main > li:lt('+($('ul.chat-main > li').length-settings.custom.chat_cleaner)+')').remove(),$('.chat-messages').perfectScrollbar('update'))},myModule.turnOn=function(){Dubtrack.Events.bind('realtime:chat-message',this.chatCleanerCheck)},myModule.extra=function(){modal.create({title:'Chat Cleaner',content:'Please specify the number of most recent chat items that will remain in your chat history',value:settings.custom.chat_cleaner||'',placeholder:'500',maxlength:'5',confirmCallback:saveAmount})},myModule.turnOff=function(){Dubtrack.Events.unbind('realtime:chat-message',this.chatCleanerCheck)},module.exports=myModule;
...
"use strict";var dubplus_emoji=require("../emojiUtils/prepEmoji.js"),emote_module={};emote_module.id="dubplus-emotes",emote_module.moduleName="Emotes",emote_module.description="Adds twitch and bttv emotes in chat.",emote_module.category="General";function makeImage(a,b,c,d,e){return"<img class=\"emoji "+a+"-emote\" "+(d?"width=\""+d+"\" ":"")+(e?"height=\""+e+"\" ":"")+"title=\""+c+"\" alt=\""+c+"\" src=\""+b+"\" />"}var replaceTextWithEmote=function(){var b=dubplus_emoji.twitch.chatRegex;if(dubplus_emoji.twitchJSONSLoaded){var c=$(".chat-main .text").last();if(c.html()){dubplus_emoji.bttvJSONSLoaded&&(b=dubplus_emoji.bttv.chatRegex);var d=c.html().replace(b,function(e,f){var g,i,j=f.toLowerCase();return dubplus_emoji.twitch.emotes[j]?(g=dubplus_emoji.twitch.emotes[j],i=dubplus_emoji.twitch.template(g),makeImage("twitch",i,j)):dubplus_emoji.bttv.emotes[j]?(g=dubplus_emoji.bttv.emotes[j],i=dubplus_emoji.bttv.template(g),makeImage("bttv",i,j)):dubplus_emoji.tasty.emotes[j]?(i=dubplus_emoji.tasty.template(j),makeImage("tasty",i,j,dubplus_emoji.tasty.emotes[j].width,dubplus_emoji.tasty.emotes[j].height)):e});c.html(d)}}};emote_module.turnOn=function(){window.addEventListener("twitch:loaded",dubplus_emoji.loadBTTVEmotes.bind(dubplus_emoji)),dubplus_emoji.twitchJSONSLoaded?replaceTextWithEmote():dubplus_emoji.loadTwitchEmotes(),Dubtrack.Events.bind("realtime:chat-message",replaceTextWithEmote)},emote_module.turnOff=function(){Dubtrack.Events.unbind("realtime:chat-message",replaceTextWithEmote)},module.exports=emote_module;

},{"../emojiUtils/prepEmoji.js":2}],22:[function(require,module,exports){
'use strict';Object.defineProperty(exports,'__esModule',{value:!0}),exports.default=function(){$('.player_sharing').append('<span class="icon-history eta_tooltip_t"></span>'),$('.eta_tooltip_t').mouseover(eta).mouseout(hide_eta)};var eta=function(){var b=4,c=parseInt($('#player-controller div.left ul li.infoContainer.display-block div.currentTime span.min').text()),d=parseInt($('.queue-position').text()),e=d*b-b+c;0<=e?$(this).append('<div class="eta_tooltip" style="position: absolute;font: 1rem/1.5 proxima-nova,sans-serif;display: block;left: -33px;cursor: pointer;border-radius: 1.5rem;padding: 8px 16px;background: #fff;font-weight: 700;font-size: 13.6px;text-transform: uppercase;color: #000;opacity: .8;text-align: center;z-index: 9;">ETA: '+e+' minutes</div>'):$(this).append('<div class="eta_tooltip" style="position: absolute;font: 1rem/1.5 proxima-nova,sans-serif;display: block;left: -33px;cursor: pointer;border-radius: 1.5rem;padding: 8px 16px;background: #fff;font-weight: 700;font-size: 13.6px;text-transform: uppercase;color: #000;opacity: .8;text-align: center;z-index: 9;">You\'re not in the queue</div>')},hide_eta=function(){$(this).empty()};
...
(function (TIME_STAMP){
'use strict';var settings=require('../lib/settings.js'),makeLink=function(b,c){var d=document.createElement('link');return d.rel='stylesheet',d.type='text/css',d.className=b||'',d.href=c,d},load=function(b,c){if(b){var d=makeLink(c,settings.srcRoot+b+'?'+TIME_STAMP);document.head.insertAdjacentElement('beforeend',d)}},loadExternal=function(b,c){if(b){var d=makeLink(c,b);document.head.insertAdjacentElement('beforeend',d)}};module.exports={load:load,loadExternal:loadExternal};

<<<<<<< HEAD
}).call(this,'1490643371229')
=======
}).call(this,'1494719019762')
>>>>>>> upstream/master
},{"../lib/settings.js":8}],41:[function(require,module,exports){
'use strict';var GetJSON=function(b,c,d){function e(h,i){var j=new XMLHttpRequest;if(j.open('GET',h),d)for(var k in d)d.hasOwnProperty(k)&&j.setRequestHeader(k,d[k]);j.send(),j.onload=function(){var l=j.responseText;'function'==typeof i&&i(l),f&&window.dispatchEvent(f)}}var f=c?new Event(c):null;return{done:function(i){new e(b,i)}}};module.exports=GetJSON;

},{}],42:[function(require,module,exports){
'use strict';function makeButtons(a){var b='';return a?(b+='<button id="dp-modal-cancel">cancel</button>',b+='<button id="dp-modal-confirm">okay</button>'):b+='<button id="dp-modal-cancel">close</button>',b}var create=function(b){var d=Object.assign({},{title:'Dub+',content:'',value:'',placeholder:null,maxlength:999,confirmCallback:null},b),f='';d.placeholder&&(f='<textarea placeholder="'+d.placeholder+'" maxlength="'+d.maxlength+'">',f+=d.value,f+='</textarea>');var g=['<div class="dp-modal">','<aside class="container">','<div class="title">','<h1>'+d.title+'</h1>','</div>','<div class="content">','<p>'+d.content+'</p>',f,'</div>','<div class="dp-modal-buttons">',makeButtons(d.confirmCallback),'</div>','</aside>','</div>'].join('');document.body.insertAdjacentHTML('beforeend',g),'function'==typeof d.confirmCallback&&$('#dp-modal-confirm').one('click',function(){d.confirmCallback(),$('.dp-modal').remove()}),$('#dp-modal-cancel').one('click',function(){$('.dp-modal').remove()}),$(document).one('keyup',function(h){13===h.keyCode&&'function'==typeof d.confirmCallback&&(d.confirmCallback(),$('.dp-modal').remove()),27===h.keyCode&&$('.dp-modal').remove()})},close=function(){$('.dp-modal').remove()};module.exports={create:create,close:close};
...
'use strict';var settings=require('../lib/settings.js'),saveOption=function(b,c,d){settings[b][c]=d,localStorage.setItem('dubplusUserSettings',JSON.stringify(settings))},getAllOptions=function(){var b=localStorage.dubplusUserSettings;return b?JSON.parse(b):settings},toggle=function(b,c){var d=$(b);d.length&&(!0===c?d.addClass('dubplus-switch-on'):d.removeClass('dubplus-switch-on'))},toggleAndSave=function(b,c){return toggle('#'+b,c),saveOption('options',b,c)};module.exports={toggle:toggle,toggleAndSave:toggleAndSave,getAllOptions:getAllOptions,saveOption:saveOption};
...
'use strict';Object.defineProperty(exports,'__esModule',{value:!0});function deepCheck(a,b){for(var c=a.split('.'),d=c.length,e=b||window,f=0;f<d;f++){if('undefined'==typeof e[c[f]])return!1;e=e[c[f]]}return!0}function arrayDeepCheck(a,b){for(var c=a.length,d=b||window,e=0;e<c;e++)if(!deepCheck(a[e],d))return console.log(a[e],'is not found yet'),!1;return!0}function WaitFor(a,b){if('string'!=typeof a&&!Array.isArray(a))return void console.warn('WaitFor: invalid first argument');var d=function(){},e=function(){},f=Array.isArray(a)?arrayDeepCheck:deepCheck,g=Object.assign({},{interval:500,seconds:5},b),h=0,j=1e3*g.seconds/g.interval,k=function n(){h++;var o=f(a);return o?d():h<j?void window.setTimeout(n,g.interval):e()};return{then:function(o){return'function'==typeof o&&(d=o),window.setTimeout(k,g.interval),this},fail:function(o){return'function'==typeof o&&(e=o),this}}}exports.default=WaitFor;
