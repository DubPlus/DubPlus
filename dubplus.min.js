...
"use strict";var options=require("../utils/options.js");module.exports={id:"dubplus-snow",moduleName:"Snow",description:"Make it snow!",category:"General",doSnow:function(){$(document).snowfall({round:!0,shadow:!0,flakeCount:50,minSize:1,maxSize:5,minSpeed:5,maxSpeed:5})},turnOn:function(){var o=this;$.snowfall?this.doSnow():$.getScript("https://cdn.jsdelivr.net/gh/loktar00/JQuery-Snowfall/src/snowfall.jquery.js").done(function(){o.doSnow()}).fail(function(n,e,t){options.toggleAndSave(o.id,!1),console.error("Could not load snowfall jquery plugin",t)})},turnOff:function(){$.snowfall&&$(document).snowfall("clear")}};
...
}).call(this)}).call(this,'1616688258877')
