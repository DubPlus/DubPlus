...
'use strict';var modal=require('../utils/modal.js'),options=require('../utils/options.js'),settings=require('../lib/settings.js'),afk_module={};afk_module.id='dubplus-afk',afk_module.moduleName='AFK Auto-respond',afk_module.description='Toggle Away from Keyboard and customize AFK message.',afk_module.category='General',afk_module.canSend=!0,afk_module.afk_chat_respond=function(a){var b=this;if(this.canSend){var c=a.message,d=Dubtrack.session.get('username');-1<c.indexOf('@'+d)&&Dubtrack.session.id!==a.user.userInfo.userid&&(settings.custom.customAfkMessage?$('#chat-txt-message').val('[AFK] '+settings.custom.customAfkMessage):$('#chat-txt-message').val('[AFK] I\'m not here right now.'),Dubtrack.room.chat.sendMessage(),this.canSend=!1,setTimeout(function(){b.canSend=!0},3e4))}},afk_module.turnOn=function(){Dubtrack.Events.bind('realtime:chat-message',this.afk_chat_respond.bind(this))},afk_module.turnOff=function(){Dubtrack.Events.unbind('realtime:chat-message',this.afk_chat_respond)};var saveAFKmessage=function(){var a=$('.dp-modal textarea').val();''!==a&&options.saveOption('custom','customAfkMessage',a)};afk_module.extra=function(){modal.create({title:'Custom AFK Message',content:'Enter a custom Away From Keyboard [AFK] message here',value:settings.custom.customAfkMessage||'',placeholder:'Be right back!',maxlength:'255',confirmCallback:saveAFKmessage})},module.exports=afk_module;
