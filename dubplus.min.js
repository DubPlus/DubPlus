var dubplus = (function () {
  ...
  const Ms = 'dubplus-community-css',
    Ls = {
      id: 'community-theme',
        ...
        fetch(`https://api.queup.net/room/${e}`)
          ...
          .then((e) => {
            ...
            if (
              ...
              return (Yn('loading community css theme from:', o), Us(o, Ms));
      ...
      turnOff() {
        var e;
        null == (e = document.getElementById(Ms)) || e.remove();
      },
    },
    zs = 'dubplus-user-custom-css',
    Qs = {
      id: 'custom-css',
      ...
      custom: {
        ...
        onConfirm(e) {
          ...
          if (!e)
            return (
              null == (t = document.getElementById(zs)) || t.remove(),
              void (Co.options[Qs.id] = !1)
            );
          Us(e, zs).catch((e) => {
      ...
      turnOn() {
        Co.custom[this.id] &&
          Us(Co.custom[this.id], zs).catch((e) => {
            Hn('Error loading custom css file:', e);
          });
      },
      turnOff() {
        var e;
        null == (e = document.getElementById(zs)) || e.remove();
      },
    };
  function $s(e) {
    const t = wo();
      ...
      custom: {
        ...
        onConfirm(e) {
          e
            ...
            : ((window.QueUp.room.chat.mentionChatSound.url = Ts),
              (Co.options[Ns.id] = !1));
        },
      },
      turnOn() {
        ((Ts = window.QueUp.room.chat.mentionChatSound.url),
          Co.custom[this.id] &&
  ...
  function Ps() {
    ...
    (isNaN(e) && (e = 30),
      ...
      (Ds = setTimeout(qs, 60 * e * 1e3)));
  }
  function Fs() {
    Ds
      ? (Yn('auto-afk onFocus: clearing timer'), clearTimeout(Ds), (Ds = null))
  ...
  const Bs = {
    ...
    turnOn() {
      var e, t;
      ((t = Ps), (e = Fs) && Pi.push(e), t && qi.push(t));
    },
    turnOff() {
      var e, t;
      ((t = Ps),
        (e = Fs) && Pi.splice(Pi.indexOf(e), 1),
  ...
  const Rs = {
    ...
    category: 'general',
    turnOn() {
      window.QueUp.Events.bind(oi, Vs);
    },
    turnOff() {
      window.QueUp.Events.unbind(oi, Vs);
    },
    custom: {
  ...
  function Ks(e) {
    if (null == e ? void 0 : e.chatid) {
      const t = document.querySelector(`.chat-id-${e.chatid}`);
      if (t) return void Js(t.querySelector('.autolink-image'));
    }
    go().forEach(Js);
  }
  const Ys = {
    ...
    category: 'general',
    turnOn(e) {
      (window.QueUp.Events.bind(ri, Ks),
        e
          ? setTimeout(() => {
              Ks();
            }, 1e3)
    ...
    turnOff() {
      (window.QueUp.Events.unbind(ri, Ks),
        ...
        document.querySelectorAll('.dubplus-collapser').forEach((e) => {
          (e.removeEventListener('click', Ws), e.remove());
        }),
  ...
  const Xs = {
      ...
      secondaryAction: {
        ...
        onClick: () => {
          const e = 'left' === (Co.custom[Xs.id] || 'right') ? 'right' : 'left';
  ...
  var ur = (e, t, n) => t(Xt(n).username),
    ...
    dr = bn('<li><!></li>'),
    pr = bn('<div role="none"><ul id="dubinfo-preview"><!></ul></div>');
  function fr(e, t) {
    de(t, !0);
    let n = Ee(() => {
  ...
  function kr() {
    (!(function () {
      ...
      const t = hr();
      mr = Number(
        (null == (e = null == t ? void 0 : t.dataset) ? void 0 : e.count) || mr,
      );
    })(),
      (function (e = 200) {
        let t = '';
  ...
  var xr = bn('<div id="snow-container" class="svelte-qgqre1"></div>');
  var Er = bn(
    ...
    Ur =
      ...
      function () {
        return 1 === arguments.length
          ? (Je(Cr, Xt(Cr) + 1), arguments[0])
          : (Xt(Cr), Or());
      }),
    Mr = bn('<!> <!>', 1);
  var Lr = bn('<!> <!>', 1);
  function zr(e, t, n, o, i, s) {
  ...
  function Tr(e, t) {
    ...
    var u = at(a, 2),
      c = (e) => {
        ...
        fr(n, { dubType: 'updub' });
        var o = at(n, 2);
        (fr(o, { dubType: 'downdub' }),
          fr(at(o, 2), { dubType: 'grab' }),
          xn(e, t));
      };
    On(u, (e) => {
    ...
    var d = at(u, 2),
      p = (e) => {
        !(function (e, t) {
          (de(t, !1),
            Rn(() => {
              (kr(), window.addEventListener('resize', kr));
            }),
            Wn(() => {
              window.removeEventListener('resize', kr);
            }),
            Bn());
          var n = xr();
          ($n(
    ...
    !(function (e, t) {
      (de(t, !1),
        er.forEach((e) => {
          Ur().options[e.id] || Ur((Ur().options[e.id] = !1));
        }),
        Bn());
      var n = Mr(),
        o = rt(n);
  ...
  const jr = 'dubplusExtensionLoaded' in window;
  var Dr, qr;
  (Yn('Dub+: loaded as extension:', jr),
    jr ||
      ((Dr = '/dubplus.css'),
      (qr = 'dubplus-css'),
      new Promise((e, t) => {
        var n;
        null == (n = document.querySelector(`link.${qr}`)) || n.remove();
        ...
        })(qr, `//cdn.jsdelivr.net/gh/DubPlus/DubPlus${Dr}?1753324159104`);
        ((o.onload = () => e()), (o.onerror = t), document.head.appendChild(o));
      })).catch((e) => {
        Hn('Failed to load dubplus.css', e);
      }));
  let Pr = document.getElementById('dubplus-container');
  Pr
  ...
  const Fr = (function (
    ...
    function (e, t) {
      (de(t, !0), (window.dubplus = Object.assign(window.dubplus || {}, Nr)));
      let n = Re('loading');
      function o(e) {
