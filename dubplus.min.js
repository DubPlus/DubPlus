...
"use strict";var GetJSON=require("../utils/getJSON.js"),settings=require("../lib/settings.js");!function(){function a(g,h){return c?void(c.transaction("s").objectStore("s").get(g).onsuccess=function(i){var j=i.target.result&&i.target.result.v||null;h(j)}):void setTimeout(function(){a(g,h)},100)}var b=window.indexedDB||window.mozIndexedDB||window.webkitIndexedDB||window.msIndexedDB;if(!b)return void console.error("indexDB not supported");var c,d={k:"",v:""},f=b.open("d2",1);f.onsuccess=function(){c=this.result},f.onerror=function(g){console.error("indexedDB request error"),console.log(g)},f.onupgradeneeded=function(g){c=null;var h=g.target.result.createObjectStore("s",{keyPath:"k"});h.transaction.oncomplete=function(i){c=i.target.db}},window.ldb={get:a,set:function set(g,h){d.k=g,d.v=h,c.transaction("s","readwrite").objectStore("s").put(d)}}}();var prepEmoji={};prepEmoji.emoji={template:function template(a){return emojify.defaultConfig.img_dir+"/"+encodeURI(a)+".png"}},prepEmoji.twitch={template:function template(a){return"//static-cdn.jtvnw.net/emoticons/v1/"+a+"/3.0"},specialEmotes:[],emotes:{},chatRegex:/:([-_a-z0-9]+):/ig},prepEmoji.bttv={template:function template(a){return"//cdn.betterttv.net/emote/"+a+"/3x"},emotes:{},chatRegex:/:([&!()\-_a-z0-9]+):/ig},prepEmoji.tasty={template:function template(a){return this.emotes[a].url},emotes:{}},prepEmoji.frankerFacez={template:function template(a){return"//cdn.frankerfacez.com/emoticon/"+a+"/1"},emotes:{},chatRegex:/:([-_a-z0-9]+):/ig},prepEmoji.shouldUpdateAPIs=function(a,b){ldb.get(a+"_api",function(d){if(d){var f=JSON.parse(d);"undefined"!=typeof f.error&&b(!0)}var g=Date.now(),h=parseInt(localStorage.getItem(a+"_api_timestamp"));b(isNaN(h)||g-h>5*8.64e7||!d)})},prepEmoji.loadTwitchEmotes=function(){var a;this.shouldUpdateAPIs("twitch",function(b){if(b){console.log("dub+","twitch","loading from api");var c=new GetJSON("//cdn.jsdelivr.net/gh/Jiiks/BetterDiscordApp/data/emotedata_twitch_global.json","twitch:loaded");c.done(function(d){var f=JSON.parse(d),g={};for(var h in f.emotes)g[h]||(g[h]=f.emotes[h].image_id);localStorage.setItem("twitch_api_timestamp",Date.now().toString()),ldb.set("twitch_api",JSON.stringify(g)),prepEmoji.processTwitchEmotes(g)})}else ldb.get("twitch_api",function(d){console.log("dub+","twitch","loading from IndexedDB"),a=JSON.parse(d),prepEmoji.processTwitchEmotes(a),a=null;var f=new Event("twitch:loaded");window.dispatchEvent(f)})})},prepEmoji.loadBTTVEmotes=function(){var a;this.shouldUpdateAPIs("bttv",function(b){if(b){console.log("dub+","bttv","loading from api");var c=new GetJSON("//api.betterttv.net/3/cached/emotes/global","bttv:loaded");c.done(function(d){var f=JSON.parse(d),g={};f.forEach(function(h){g[h.code]||(g[h.code]=h.id)}),localStorage.setItem("bttv_api_timestamp",Date.now().toString()),ldb.set("bttv_api",JSON.stringify(g)),prepEmoji.processBTTVEmotes(g)})}else ldb.get("bttv_api",function(d){console.log("dub+","bttv","loading from IndexedDB"),a=JSON.parse(d),prepEmoji.processBTTVEmotes(a),a=null;var f=new Event("bttv:loaded");window.dispatchEvent(f)})})},prepEmoji.loadTastyEmotes=function(){var a=this;console.log("dub+","tasty","loading from api");var b=new GetJSON(settings.srcRoot+"/emotes/tastyemotes.json","tasty:loaded");b.done(function(c){ldb.set("tasty_api",JSON.stringify(c)),a.processTastyEmotes(JSON.parse(c))})},prepEmoji.loadFrankerFacez=function(){var a;this.shouldUpdateAPIs("frankerfacez",function(b){if(b){console.log("dub+","frankerfacez","loading from api");var c=new GetJSON("//api.frankerfacez.com/v1/emoticons?per_page=200&private=off&sort=count-desc","frankerfacez:loaded");c.done(function(d){var f=JSON.parse(d);localStorage.setItem("frankerfacez_api_timestamp",Date.now().toString()),ldb.set("frankerfacez_api",d),prepEmoji.processFrankerFacez(f)})}else ldb.get("frankerfacez_api",function(d){console.log("dub+","frankerfacez","loading from IndexedDB"),a=JSON.parse(d),prepEmoji.processFrankerFacez(a),a=null;var f=new Event("frankerfacez:loaded");window.dispatchEvent(f)})})},prepEmoji.processTwitchEmotes=function(a){for(var b in a)if(a.hasOwnProperty(b)){var c=b.toLowerCase();if(0<=b.indexOf("\\")){this.twitch.specialEmotes.push([b,a[b]]);continue}if(0<=emojify.emojiNames.indexOf(c))continue;this.twitch.emotes[c]||(this.twitch.emotes[c]=a[b])}this.twitchJSONSLoaded=!0,this.emojiEmotes=emojify.emojiNames.concat(Object.keys(this.twitch.emotes))},prepEmoji.processBTTVEmotes=function(a){for(var b in a)if(a.hasOwnProperty(b)){var c=b.toLowerCase();if(0<=b.indexOf(":"))continue;if(0<=emojify.emojiNames.indexOf(c))continue;0<=b.indexOf("(")&&(c=c.replace(/([()])/g,"")),this.bttv.emotes[c]=a[b]}this.bttvJSONSLoaded=!0,this.emojiEmotes=this.emojiEmotes.concat(Object.keys(this.bttv.emotes))},prepEmoji.processTastyEmotes=function(a){this.tasty.emotes=a.emotes,this.tastyJSONLoaded=!0,this.emojiEmotes=this.emojiEmotes.concat(Object.keys(this.tasty.emotes))},prepEmoji.processFrankerFacez=function(a){var b=!0,c=!1,d=void 0;try{for(var g,f=a.emoticons[Symbol.iterator]();!(b=(g=f.next()).done);b=!0){var h=g.value,i=h.name,j=i.toLowerCase().replace("~","-");0<=i.indexOf(":")||0<=emojify.emojiNames.indexOf(j)||(0<=i.indexOf("(")&&(j=j.replace(/([()])/g,"")),this.frankerFacez.emotes[j]=h.id)}}catch(k){c=!0,d=k}finally{try{!b&&f.return&&f.return()}finally{if(c)throw d}}this.frankerfacezJSONLoaded=!0,this.emojiEmotes=this.emojiEmotes.concat(Object.keys(this.frankerFacez.emotes))},module.exports=prepEmoji;
...
"use strict";var myModule={};myModule.id="dubplus-grabschat",myModule.moduleName="Grabs in Chat",myModule.description="Toggle showing grabs in the chat box",myModule.category="General",myModule.grabChatWatcher=function(a){var b=QueUp.session.get("username"),c=QueUp.room.users.collection.findWhere({userid:QueUp.room.player.activeSong.attributes.song.userid}).attributes._user.username;if(b===c&&!QueUp.room.model.get("displayUserGrab")){var d="\n      <li class=\"dubplus-chat-system dubplus-chat-system-grab\">\n        <div class=\"chatDelete\" onclick=\"dubplus.deleteChatMessageClientSide(this)\">\n          <span class=\"icon-close\"></span>\n        </div>\n        <div class=\"text\">\n          @"+a.user.username+" has grabbed your song "+QueUp.room.player.activeSong.attributes.songInfo.name+"\n        </div>\n      </li>";$("ul.chat-main").append(d)}},myModule.turnOn=function(){QueUp.Events.bind("realtime:room_playlist-queue-update-grabs",this.grabChatWatcher),"function"!=typeof window.dubplus.deleteChatMessageClientSide&&(window.dubplus.deleteChatMessageClientSide=function(a){$(a).parent("li")[0].remove()})},myModule.turnOff=function(){QueUp.Events.unbind("realtime:room_playlist-queue-update-grabs",this.grabChatWatcher)},module.exports=myModule;
...
'use strict';Object.defineProperty(exports,'__esModule',{value:!0}),exports.default=function(){$('.player_sharing').append('<span class="icon-mute snooze_btn"></span>'),$('body').on('mouseover','.snooze_btn',snooze_tooltip),$('body').on('mouseout','.snooze_btn',hide_snooze_tooltip),$('body').on('click','.snooze_btn',snooze)};var snooze_tooltip=function(){$(this).append('<div class="snooze_tooltip" style="position: absolute;font: 1rem/1.5 proxima-nova,sans-serif;display: block;left: -33px;cursor: pointer;border-radius: 1.5rem;padding: 8px 16px;background: #fff;font-weight: 700;font-size: 13.6px;text-transform: uppercase;color: #000;opacity: .8;text-align: center;z-index: 9;">Mute current song</div>')},hide_snooze_tooltip=function(){$('.snooze_tooltip').remove()},eventUtils={currentVol:50,snoozed:!1},eventSongAdvance=function(a){if(2>a.startTime)return eventUtils.snoozed&&(QueUp.room.player.setVolume(eventUtils.currentVol),eventUtils.snoozed=!1),!0},snooze=function(){eventUtils.snoozed||QueUp.room.player.muted_player||!(2<QueUp.playerController.volume)?eventUtils.snoozed&&(QueUp.room.player.setVolume(eventUtils.currentVol),QueUp.room.player.updateVolumeBar(),eventUtils.snoozed=!1):(eventUtils.currentVol=QueUp.playerController.volume,QueUp.room.player.mutePlayer(),eventUtils.snoozed=!0,QueUp.Events.bind('realtime:room_playlist-update',eventSongAdvance))};

},{}],35:[function(require,module,exports){
"use strict";var options=require("../utils/options.js");module.exports={id:"dubplus-snow",moduleName:"Snow",description:"Make it snow!",category:"General",doSnow:function doSnow(){$(document).snowfall({round:!0,shadow:!0,flakeCount:50,minSize:1,maxSize:5,minSpeed:5,maxSpeed:5})},turnOn:function turnOn(){var a=this;$.snowfall?this.doSnow():$.getScript("https://cdn.jsdelivr.net/gh/loktar00/JQuery-Snowfall/src/snowfall.jquery.js").done(function(){a.doSnow()}).fail(function(b,c,d){options.toggleAndSave(a.id,!1),console.error("Could not load snowfall jquery plugin",d)})},turnOff:function turnOff(){$.snowfall&&$(document).snowfall("clear")}};

},{"../utils/options.js":45}],36:[function(require,module,exports){
"use strict";var myModule={};myModule.id="dubplus-spacebar-mute",myModule.moduleName="Spacebar Mute",myModule.description="Turn on/off the ability to mute current song with the spacebar.",myModule.category="Settings",myModule.turnOn=function(){$(document).bind("keypress.key32",function(a){var b=a.target.tagName.toLowerCase();32===a.which&&"input"!==b&&"textarea"!==b&&QueUp.room.player.mutePlayer()})},myModule.turnOff=function(){$(document).unbind("keypress.key32")},module.exports=myModule;
...
"use strict";var myModule={};myModule.id="dubplus-updubs",myModule.moduleName="Updubs in Chat",myModule.description="Toggle showing updubs in the chat box",myModule.category="General",myModule.updubWatcher=function(a){var b=QueUp.session.get("username"),c=QueUp.room.users.collection.findWhere({userid:QueUp.room.player.activeSong.attributes.song.userid}).attributes._user.username;if(b===c&&"updub"===a.dubtype){var d="\n      <li class=\"dubplus-chat-system dubplus-chat-system-updub\">\n        <div class=\"chatDelete\" onclick=\"dubplus.deleteChatMessageClientSide(this)\">\n          <span class=\"icon-close\"></span>\n        </div>\n        <div class=\"text\">\n          @"+a.user.username+" has updubbed your song "+QueUp.room.player.activeSong.attributes.songInfo.name+"\n        </div>\n      </li>";$("ul.chat-main").append(d)}},myModule.turnOn=function(){QueUp.Events.bind("realtime:room_playlist-dub",this.updubWatcher),"function"!=typeof window.dubplus.deleteChatMessageClientSide&&(window.dubplus.deleteChatMessageClientSide=function(a){$(a).parent("li")[0].remove()})},myModule.turnOff=function(){QueUp.Events.unbind("realtime:room_playlist-dub",this.updubWatcher)},module.exports=myModule;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=function(a){return QueUp.helpers.isSiteAdmin(a)||QueUp.room.users.getIfOwner(a)||QueUp.room.users.getIfManager(a)||QueUp.room.users.getIfMod(a)};
