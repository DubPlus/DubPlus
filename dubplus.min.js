var dubplus = (function () {
  ...
  function ke(e) {
    ...
    null === Qt || (null !== n && 0 !== (n.f & D)) ? (t |= D) : (Qt.f |= K);
    return {
      ctx: ue,
      deps: null,
      effects: null,
  ...
  function Ce(e) {
    ...
    (e.equals(t) || ((e.v = t), (e.wv = Vt())), Ct) ||
      (null !== Qe
        ? Qe.set(e, e.v)
        : tn(e, (!Bt && 0 === (e.f & D)) || null === e.deps ? q : F));
  }
  function Ue(e, t, n) {
    const o = fe() ? ke : _e;
    if (0 !== t.length) {
      ...
      for (var n = e.first; null !== n; ) {
        ...
        if (
          ...
          if (i) n.f ^= q;
            ...
            else (16 & n.f && g(this, u).push(n), Yt(n));
          }
          var a = n.first;
          if (null !== a) {
            n = a;
  ...
  let je = class f {
    ...
    process(t) {
      ...
      for (const e of g(this, s)) Yt(e);
      for (const e of g(this, r)) Yt(e);
      (y(this, s, []), y(this, r, []));
    }
    capture(t, n) {
    ...
    decrement() {
      if ((y(this, n, g(this, n) - 1), 0 === g(this, n))) {
        for (const e of this.current.keys()) Ye(e, P, !1);
      ...
      for (var n = 0; n < t; ) {
        ...
        if (!(24576 & o.f) && Rt(o)) {
          ...
          if (
            ...
            null !== ze && ze.current.size > i && 0 !== (o.f & H))
          )
            break;
        }
      }
  ...
  function Ke(e, t) {
    if (!e.equals(t)) {
      ...
      (Ct ? Be.set(e, t) : Be.set(e, n),
        (e.v = t),
        je.ensure().capture(e, n),
        2 & e.f && (0 !== (e.f & P) && Oe(e), tn(e, 0 === (e.f & D) ? q : F)),
        (e.wv = Vt()),
        Ye(e, P),
        !fe() ||
          null === Qt ||
    ...
    if (0 !== (n & F)) {
      ...
      if (null !== o) {
        ...
        if ((a || l) && (null === Qt || 0 === (Qt.f & V))) {
          ...
          (a && (c.f ^= j), l && null !== d && 0 === (d.f & D) && (c.f ^= D));
        }
        for (s = 0; s < u; s++)
  ...
  function Jt(e) {
    ...
    try {
      ...
      } else null !== f && Nt < f.length && (Ht(e, Nt), (f.length = Nt));
      if (fe() && null !== Dt && !Lt && null !== f && !(6146 & e.f))
        for (m = 0; m < Dt.length; m++) Wt(Dt[m], e);
      return (
        null !== s &&
          s !== e &&
          (qt++, null !== Dt && (null === i ? (i = Dt) : i.push(...Dt))),
        0 !== (e.f & G) && (e.f ^= G),
        p
      );
    } catch (e) {
  ...
  function Kt(e, t) {
    ...
    null === n &&
      ...
      (tn(t, F), 768 & t.f || (t.f ^= j), Se(t), Ht(t, 0));
  }
  function Ht(e, t) {
    var n = e.deps;
    ...
    if (0 === (t & V)) {
      ...
      try {
        (16 & t
          ...
          ht(e));
        var i = Jt(e);
        ((e.teardown = 'function' == typeof i ? i : null), (e.wv = jt));
      } finally {
        ((St = o), (Qt = n));
      }
    }
  ...
  function Cn(e, t, n, o, i, s = null) {
    ...
    function m() {
      (!(function (e, t, n, o, i, s, r, a, l) {
        ...
        for (var D of ((e.first = n.first && n.first.e),
        (e.last = O && O.e),
        o.values()))
          gt(D.e);
        o.clear();
  ...
  function Gn(e, t = {}) {
    const n = Object.assign({}, { interval: 500, seconds: 10 }, t);
    return new Promise((t, o) => {
      let i = 0;
      const s = (1e3 * n.seconds) / n.interval,
        r = () => {
          (i++, e() ? t() : i < s ? window.setTimeout(r, n.interval) : o());
        };
      r();
    });
  }
      ...
      return (
        ...
        o
          ? (Object.keys(n).forEach((e) => {
            ...
            o)
          : (Yn(`No translation found for ${e}.${t}`), t)
      );
    })(no.current, e, t);
  }
  var io = bn(
  ...
  function mo(e, t) {
    ...
    var p = at(c, 2),
      f = (e) => {
        var t = lo();
        (ft(() => {
          (jn(t, 'placeholder', so.placeholder),
            jn(t, 'maxlength', so.maxlength < 999 ? so.maxlength : 999));
        }),
          (function (e, t, n = t) {
            var o = fe(),
              i = new WeakSet();
  ...
  const So = {
    ...
    Oo = {
      customAfkMessage: So['dubplus-afk'],
      custom_mentions: So.custom_mentions,
      chat_cleaner: So['chat-cleaner'],
      dj_notification: So.dj_notification,
      css: So['dubplus-custom-css'],
      bg: So['dubplus-custom-bg'],
      notificationSound: So['dubplus-custom-notification-sound'],
      'dubplus-custom-notification-sound':
        So['dubplus-custom-notification-sound'],
    };
  const Co = 'dubplusUserSettingsV2';
  let Uo = Xe(
    Object.assign(
      {},
      {
      ...
      (function () {
        try {
          const e = JSON.parse(localStorage.getItem(Co));
          if (e) return e;
        } catch (e) {
          Hn('Error loading v2 settings, trying old settings. Error:', e);
        }
        try {
            ...
            return (function (e) {
              ...
              for (const [n, o] of Object.entries(e.options)) {
                ...
                try {
                  ...
                  Yn('Error converting options', t.message, n, e, o);
                }
              }
              for (const [n, o] of Object.entries(e.custom)) {
                ...
                try {
                  ...
                  Yn('Error converting custom', t.message, n, e, o);
                }
              }
              return t;
            })(e);
        } catch (e) {
          Hn('Error loading old settings:', e);
        }
        return {};
      })(),
    ),
  ...
  function Mo() {
    try {
      localStorage.setItem(Co, JSON.stringify(Uo));
    } catch (e) {
      Yn('Error saving user settings:', e);
    }
  }
  function Lo(e, t, n) {
    if ('option' === e) return ((Uo.options[t] = n), void Mo());
    if ('custom' === e) return ((Uo.custom[t] = n), void Mo());
    if ('menu' === e) return ((Uo.menu[t] = n), void Mo());
  ...
  function Qo(e, t) {
    ...
    let n = Re('down'),
      o = Re(!0);
    ct(() => {
      'closed' === Uo.menu[t.settingsId]
        ? (Je(n, 'right'), Je(o, !1))
        : (Je(n, 'down'), Je(o, !0));
    });
    var i = zo();
    i.__click = function () {
      ((Uo.menu[t.settingsId] =
        'closed' === Uo.menu[t.settingsId] ? 'open' : 'closed'),
        Lo('menu', t.settingsId, Uo.menu[t.settingsId]));
    };
    var s = st(i),
      r = st(at(s, 2));
    (ft(() => {
      (jn(i, 'id', `dubplus-menu-section-header-${t.settingsId}`),
        jn(i, 'aria-expanded', Xt(o)),
        jn(i, 'aria-controls', `dubplus-menu-section-${t.settingsId}`),
  ...
  function Ao(e, t) {
    ...
    (!(function (e, t, ...n) {
      ...
      ft(() => {
        (jn(n, 'id', `dubplus-menu-section-${t.settingsId}`),
          jn(
            n,
            'aria-labelledby',
  ...
  function ni(e, t) {
    var n;
    de(t, !0);
    const o = (null == (n = t.secondaryAction) ? void 0 : n.icon) || Xo;
    function i() {
      (ro({
    ...
    (Rn(() => {
      if ((t.init && t.init(), Uo.options[t.id])) {
        (!t.modOnly || Go(window.QueUp.session.id)) && t.turnOn(!0);
      }
    }),
      Wn(() => {
        Uo.options[t.id] && t.turnOff();
      }));
    var s = ti();
    let r;
    var a = st(s);
    {
      let e = Ee(() => !!t.modOnly && !Go(window.QueUp.session.id)),
        n = Ee(() => oo(t.label));
      !(function (e, t) {
        function n() {
          ((Uo.options[t.optionId] = !Uo.options[t.optionId]),
            t.onToggle(Uo.options[t.optionId]));
        }
        de(t, !0);
        var o = Ho();
        ((o.__click = [Ko, t, n]), (o.__keydown = [Jo, t, n]));
        var i = at(st(o), 2),
          s = st(i);
        (ft(() => {
          (jn(o, 'aria-disabled', t.disabled ? 'true' : 'false'),
            jn(o, 'aria-checked', Uo.options[t.optionId] ? 'true' : 'false'),
            En(s, t.label));
        }),
          xn(e, o),
          pe());
        ...
        onToggle: (e) => {
          !t.customize || !0 !== e || Uo.custom[t.id]
            ? (Lo('option', t.id, e), e ? t.turnOn() : t.turnOff())
            : i();
        },
        get optionId() {
          return t.id;
    ...
    (On(c, (e) => {
      ...
      ft(
        (e, n) => {
          (jn(s, 'id', `dubplus-${t.id}`),
            jn(s, 'title', e),
            (r = In(s, 0, 'svelte-1dzj03i', null, r, n)));
        },
        [
          () => oo(t.description),
          () => ({ disabled: !!t.modOnly && !Go(window.QueUp.session.id) }),
        ],
      ),
      xn(e, s),
      pe());
  ...
  fn(['click']);
  const oi = 'realtime:room_playlist-dub',
    ii = 'realtime:room_playlist-queue-update-grabs',
    si = 'realtime:user-leave',
    ri = 'realtime:room_playlist-update',
    ai = 'realtime:chat-message',
    li = 'realtime:new-message';
  function ui() {
    var e, t, n;
    null ==
      (n =
  ...
  const ci = {
    ...
    category: 'general',
    turnOff() {
      window.QueUp.Events.unbind(ri, ui);
    },
    turnOn() {
      (ui(), window.QueUp.Events.bind(ri, ui));
    },
  };
  function di(e, t) {
  ...
  const vi = {
      ...
      category: 'general',
      turnOn() {
        window.QueUp.Events.bind(ai, mi);
      },
      turnOff() {
        window.QueUp.Events.unbind(ai, mi);
      },
      custom: {
  ...
  const bi = new (class {
    constructor() {
      ...
      ((e.onsuccess = function () {
        ...
        (e.onupgradeneeded = function () {
          ((t.db = null),
            (this.result.createObjectStore(hi, {
              keyPath: 'k',
    ...
    get(e) {
      return new Promise((t) => {
        this.db
          ? (this.db.transaction(hi).objectStore(hi).get(e).onsuccess =
              function () {
                var e;
    ...
    set(e, t) {
      this.db.transaction(hi, 'readwrite').objectStore(hi).put({ k: e, v: t });
    }
  })();
  const gi = {
    emoji: {
                ...
                fetch(
                  ...
                  .then((e) => {
                    ...
                    (localStorage.setItem(
                      ...
                      bi.set('twitch_api', JSON.stringify(t)),
                      gi.processTwitchEmotes(t));
                  })
                  .catch((e) => Yn(e)))
              : bi.get('twitch_api').then((e) => {
                  Hn('twitch', 'loading from IndexedDB');
                ...
                fetch('//api.betterttv.net/3/cached/emotes/global')
                  ...
                  .then((e) => {
                    ...
                    (e.forEach((e) => {
                      ...
                      bi.set('bttv_api', JSON.stringify(t)),
                      gi.processBTTVEmotes(t));
                  })
                  .catch((e) => Yn(e)))
              : bi.get('bttv_api').then((e) => {
                  Hn('bttv', 'loading from IndexedDB');
                  const t = JSON.parse(e);
                  gi.processBTTVEmotes(t);
                }),
          );
    ...
    loadFrankerFacez() {
      return this.frankerfacezJSONLoaded
        ...
        : this.shouldUpdateAPIs('frankerfacez').then((e) =>
            e
              ? (Hn('frankerfacez', 'loading from api'),
                fetch(
                  ...
                  .then((e) => {
                    ...
                    (localStorage.setItem(
                      ...
                      bi.set('frankerfacez_api', JSON.stringify(t)),
                      gi.processFrankerFacez(t));
                  })
                  .catch((e) => Yn(e)))
              : bi.get('frankerfacez_api').then((e) => {
                  Hn('frankerfacez', 'loading from IndexedDB');
                  const t = JSON.parse(e);
                  gi.processFrankerFacez(t);
                }),
          );
          ...
          return (
            n.forEach((e) => {
              if (e.match(t)) {
                ...
                if (gi.twitchJSONSLoaded && gi.twitch.emotesMap.has(t)) {
                  const e = gi.twitch.emotesMap.get(t),
                    n = wi('twitch', gi.twitch.template(e), t);
                  o.push(n);
                } else if (gi.bttvJSONSLoaded && gi.bttv.emotesMap.has(t)) {
                  const e = gi.bttv.emotesMap.get(t),
                    n = wi('bttv', gi.bttv.template(e), t);
                  o.push(n);
                } else if (
                  gi.frankerfacezJSONLoaded &&
                  gi.frankerFacez.emotesMap.has(t)
                ) {
                  const e = gi.frankerFacez.emotesMap.get(t),
                    n = wi('frankerFacez', gi.frankerFacez.template(e), t);
                  o.push(n);
  ...
  function ki(e) {
    if (null == e ? void 0 : e.chatid) {
      ...
      if (t) return void yi(t);
    }
    const t = go();
    (null == t ? void 0 : t.length) && t.forEach(yi);
  }
  const xi = {
      id: 'emotes',
      label: 'emotes.label',
      ...
      turnOn() {
        gi.loadTwitchEmotes()
          .then(() => gi.loadBTTVEmotes())
          .then(() => gi.loadFrankerFacez())
          .then(() => {
            (ki(), window.QueUp.Events.bind(ai, ki));
          });
      },
      turnOff() {
    ...
    Ei = Xe({ selectedIndex: 0, emojiList: [] });
  function _i() {
    ((Ei.selectedIndex = 0), (Ei.emojiList = []));
  }
  function Si(e) {
    return ' ' === e || '\n' === e;
  }
  ...
  let Ci,
    Ui = document.querySelector('#autocomplete-preview');
  function Mi(e, t) {
    const n = Ei.emojiList[t],
      [o, i] = (function (e, t) {
        let n = t > 0 ? t : 0;
        for (; n > 0 && ':' !== e[n]; ) n -= 1;
        let o = t;
        for (; !Si(e[o]) && o < e.length; ) o += 1;
        return [n, o];
      })(e.value, e.selectionStart),
      s = e.value.substring(o, i);
    ((e.value = e.value.replace(s, `:${n.text}:`)), _i());
  }
  function Li(e) {
    const t = e.target,
      n = t.value,
    ...
    let i = '',
      s = o - 1;
    for (; !Si(n[s]) && s >= 0; ) ((i = n[s] + i), s--);
    let r = o;
    for (; !Si(n[r]) && r < n.length; ) ((i += n[r]), r++);
    if (i.startsWith(':') && i.length >= 2 && !i.endsWith(':')) {
      ...
      })(gi.findMatchingEmotes(e, Uo.options.emotes), e);
    } else _i();
  }
  function zi(e) {
    Ui = Ui || document.querySelector('#autocomplete-preview');
    const t = Ui.children.length > 0;
    if (!(e.shiftKey || e.ctrlKey || e.altKey || e.metaKey)) {
      if (e.key === Oi.up && t)
        return (
          e.preventDefault(),
          void (Ei.selectedIndex > 0
            ? Ei.selectedIndex--
            : (Ei.selectedIndex = Ei.emojiList.length - 1))
        );
      if (e.key === Oi.down && t)
        return (
          e.preventDefault(),
          void (Ei.selectedIndex < Ei.emojiList.length - 1
            ? Ei.selectedIndex++
            : (Ei.selectedIndex = 0))
        );
      if ((e.key === Oi.enter || e.key === Oi.tab) && t) {
        (e.preventDefault(), e.stopImmediatePropagation());
        return void Mi(e.target, Ei.selectedIndex);
      }
      e.key !== Oi.enter || t || e.shiftKey
        ? e.key === Oi.esc && t
          ? _i()
          : Li(e)
        : setTimeout(() => {
  ...
  function Qi(e) {
    Ui = Ui || document.querySelector('#autocomplete-preview');
    const t = 0 === Ui.children.length,
      n = [Oi.tab, Oi.enter, Oi.up, Oi.down].includes(e.key),
  ...
  const $i = {
      ...
      turnOn() {
        ((Ui = document.querySelector('#autocomplete-preview')),
          _i(),
          (Ci = window.QueUp.room.chat.events['keydown #chat-txt-message']));
        const e = { ...window.QueUp.room.chat.events };
        (delete e['keydown #chat-txt-message'],
          window.QueUp.room.chat.delegateEvents(e));
        const t = ho();
        (t.addEventListener('keydown', Qi),
          t.addEventListener('keyup', zi),
          t.addEventListener('click', Li));
      },
      turnOff() {
        (_i(),
          (window.QueUp.room.chat.events['keydown #chat-txt-message'] = Ci),
          window.QueUp.room.chat.delegateEvents(window.QueUp.room.chat.events));
        const e = ho();
        (e.removeEventListener('keydown', Qi),
          e.removeEventListener('keyup', zi),
          e.removeEventListener('click', Li));
      },
    },
    Ai = 'custom-mentions';
  function Ii(e) {
    const t = Uo.options[Ai],
      n = Uo.custom[Ai];
  ...
  const Ti = {
      ...
      custom: {
        ...
        placeholder: `${Ai}.modal.placeholder`,
        maxlength: 255,
      },
      turnOn() {
        window.QueUp.Events.bind(ai, Ii);
      },
      turnOff() {
        window.QueUp.Events.unbind(ai, Ii);
      },
    },
    Ni = 'chat-cleaner';
  function Di(e) {
  ...
  function ji() {
    const e = Uo.custom[Ni];
    if ('number' == typeof e) Di(e);
  ...
  const qi = {
      ...
      category: 'general',
      custom: {
        title: `${Ni}.modal.title`,
        content: `${Ni}.modal.content`,
        placeholder: `${Ni}.modal.placeholder`,
        maxlength: 5,
        validation(e) {
          if ('' === e.trim()) return !0;
          ...
          return (
            ...
            oo(`${Ni}.modal.validation`)
          );
        },
        onConfirm: (e) => {
          Uo.options[Ni] && Di(parseInt(e, 10));
        },
      },
      turnOn() {
        (Di(void 0), window.QueUp.Events.bind(ai, ji));
      },
      turnOff() {
        window.QueUp.Events.unbind(ai, ji);
      },
    },
    Pi = Xe({ isActive: !0 }),
    Fi = [],
    Bi = [];
  function Vi(e) {
    Pi.isActive && (['blur', 'pagehide'].includes(e.type) || document.hidden)
      ? ((Pi.isActive = !1), Fi.forEach((e) => e()))
      : Pi.isActive ||
        (!['focus', 'pageshow'].includes(e.type) && document.hidden) ||
        ((Pi.isActive = !0), Bi.forEach((e) => e()));
  }
  function Ri() {
    ro({
        ...
        ? 'granted' !== Notification.permission
          ? 'denied' === Notification.permission
            ...
            : void Notification.requestPermission().then(function (n) {
                if ('denied' === n || 'default' === n) return (Ri(), void t());
                e();
              })
          : void e()
        : (ro({
  ...
  function Ji(e) {
    ...
    if (Pi.isActive && !t.ignoreActiveTab) return;
    const n = {
        body: t.content,
  ...
  function Ki(e) {
    ...
    Uo.options['custom-mentions'] &&
      Uo.custom['custom-mentions'] &&
      ((n = n
        .concat(Uo.custom['custom-mentions'].split(','))
        .map((e) => e.trim())),
      (n = n.concat(n.map((e) => '@' + e))));
    new RegExp(`\\b(${n.join('|')})\\b`, 'ig').test(t) &&
      !Pi.isActive &&
      window.QueUp.session.id !== e.user.userInfo.userid &&
      Ji({ title: `Message from ${e.user.username}`, content: t });
  }
  (document.addEventListener('visibilitychange', Vi),
    (window.onpageshow = Vi),
    (window.onpagehide = Vi),
    (window.onfocus = Vi),
    (window.onblur = Vi),
    void 0 !== document.hidden &&
      Vi({ type: document.hidden ? 'blur' : 'focus' }));
  const Hi = {
  ...
  const Xi = {
      ...
      turnOn() {
        Wi()
          .then(() => {
            window.QueUp.Events.bind(li, Yi);
          })
          .catch(() => {
            Uo.options[this.id] = !1;
          });
      ...
      turnOff() {
        window.QueUp.Events.unbind(li, Yi);
      },
    },
    Gi = 'dj-notification';
  function Zi(e) {
    (e && e.startTime > 2) ||
      setTimeout(() => {
        var e, t, n, o;
        const i =
          null == (t = null == (e = ko()) ? void 0 : e.textContent)
            ? void 0
            : t.trim();
        if (!i) return;
        const s = parseInt(i, 10);
        if (isNaN(s))
          return void Yn(Gi, 'Could not parse current position:', i);
        let r = parseInt(Uo.custom[Gi], 10);
        isNaN(r) &&
          ((r = 2), Hn(Gi, 'Could not parse setting, defaulting to 2'));
        return ((null ==
        (o =
          ...
          s === r
          ? (Ji({
              title: oo(`${Gi}.notification.title`),
              content: oo(`${Gi}.notification.content`),
              ignoreActiveTab: !0,
              wait: 1e4,
            }),
  ...
  const es = {
      ...
      category: 'general',
      custom: {
        title: `${Gi}.modal.title`,
        content: `${Gi}.modal.content`,
        placeholder: '2',
        defaultValue: '2',
        maxlength: 3,
        validation(e) {
      ...
      turnOn() {
        Wi().then(() => {
          (Zi(), window.QueUp.Events.bind(ri, Zi));
        });
      },
      turnOff() {
        window.QueUp.Events.unbind(ri, Zi);
      },
    },
    ts = Xe({ upDubs: [], downDubs: [], grabs: [] });
  const ns = window.location.hostname.includes('staging')
  ...
  function is() {
    ((ts.downDubs = []), (ts.upDubs = []), (ts.grabs = []));
    const e =
      ((t = window.QueUp.room.model.id),
      `${ns}/room/${t}/playlist/active/dubs`);
    var t;
    fetch(e)
      .then((e) => e.json())
      .then((e) => {
        ...
        (null == (t = e.data.upDubs) ||
          t.forEach((e) => {
            ts.upDubs.find((t) => t.userid === e.userid) ||
              os(e.userid)
                .then((t) => {
                  ts.upDubs.push({ userid: e.userid, username: t });
                })
                .catch((e) => Yn('Failed to get username for upDubs:', e));
          }),
          Go(window.QueUp.session.id) &&
            (null == (n = e.data.downDubs) ||
              n.forEach((e) => {
                ts.downDubs.find((t) => t.userid === e.userid) ||
                  os(e.userid)
                    .then((t) => {
                      ts.downDubs.push({ userid: e.userid, username: t });
                    })
                    .catch((e) => Yn('Failed to get username for downDubs', e));
              })));
      })
      .catch((e) => Yn('Failed to fetch dubs data from API.', e));
  }
  function ss(e) {
    'updub' === e.dubtype
      ? (ts.upDubs.find((t) => t.userid === e.user._id) ||
          ts.upDubs.push({ userid: e.user._id, username: e.user.username }),
        (ts.downDubs = ts.downDubs.filter((t) => t.userid !== e.user._id)))
      : 'downdub' === e.dubtype &&
        Go(window.QueUp.session.id) &&
        (ts.downDubs.find((t) => t.userid === e.user._id) ||
          ts.downDubs.push({ userid: e.user._id, username: e.user.username }),
        (ts.upDubs = ts.upDubs.filter((t) => t.userid !== e.user._id)));
  ...
  function rs(e) {
    ts.grabs.find((t) => t.userid === e.user._id) ||
      ts.grabs.push({ userid: e.user._id, username: e.user.username });
  }
  function as(e) {
    ((ts.upDubs = ts.upDubs.filter((t) => t.userid !== e.user._id)),
      (ts.downDubs = ts.downDubs.filter((t) => t.userid !== e.user._id)),
      (ts.grabs = ts.grabs.filter((t) => t.userid !== e.user._id)));
  }
  const ls = {
    id: 'dubs-hover',
    ...
    turnOn() {
      (is(),
        window.QueUp.Events.bind(oi, ss),
        window.QueUp.Events.bind(ii, rs),
        window.QueUp.Events.bind(si, as),
        window.QueUp.Events.bind(ri, is));
    },
    turnOff() {
      (window.QueUp.Events.unbind(oi, ss),
        window.QueUp.Events.unbind(ii, rs),
        window.QueUp.Events.unbind(si, as),
        window.QueUp.Events.unbind(ri, is));
    },
  };
  function us(e) {
  ...
  const cs = {
    ...
    modOnly: !0,
    turnOn() {
      Go(window.QueUp.session.id) && window.QueUp.Events.bind(oi, us);
    },
    turnOff() {
      window.QueUp.Events.unbind(oi, us);
    },
  };
  function ds(e) {
    window.QueUp.session.id ===
  ...
  const ps = {
    ...
    category: 'general',
    turnOn() {
      window.QueUp.Events.bind(oi, ds);
    },
    turnOff() {
      window.QueUp.Events.unbind(oi, ds);
    },
  };
  function fs(e) {
    window.QueUp.session.id ===
  ...
  const bs = {
    ...
    category: 'general',
    turnOn() {
      ((this.rainEffect = new hs()), this.rainEffect.start());
    },
    turnOff() {
  ...
  const ws = {
      ...
      onClick() {
        ...
        e
          ...
          : Hn('Fullscreen: No video element found');
      },
    },
    ys = {
      id: 'split-chat',
  ...
  const Cs = {
    ...
    category: 'settings',
    turnOn() {
      document.addEventListener('keypress', Os);
    },
    turnOff() {
      document.removeEventListener('keypress', Os);
    },
  };
  function Us(e) {
  ...
  const Ms = {
      ...
      category: 'settings',
      turnOn() {
        window.addEventListener('beforeunload', Us);
      },
      turnOff() {
        window.removeEventListener('beforeunload', Us);
      },
    },
    Ls = 'dubplus',
    zs = '4.1.1',
    Qs = 'Dub+ - A simple script/extension for QueUp.net',
    $s = 'MIT',
    As = 'https://dub.plus';
  function Is(e, t) {
    var n;
  ...
  const Ts = 'dubplus-community-css',
    Ns = {
      id: 'community-theme',
        ...
        fetch(`https://api.queup.net/room/${e}`)
          ...
          .then((e) => {
            ...
            if (
              ...
              return (Hn('loading community css theme from:', o), Is(o, Ts));
            Hn('No community CSS theme found');
          })
          .catch((e) => {
            Yn('Community CSS: Failed to load room info', e);
          });
      },
      turnOff() {
        var e;
    ...
    js = {
      ...
      custom: {
        ...
        onConfirm(e) {
          ...
          if (!e)
            return (
              null == (t = document.getElementById(Ds)) || t.remove(),
              void (Uo.options[js.id] = !1)
            );
          Is(e, Ds).catch((e) => {
            Yn('Error loading custom css file:', e);
          });
        },
      },
      turnOn() {
        Uo.custom[this.id] &&
          Is(Uo.custom[this.id], Ds).catch((e) => {
            Yn('Error loading custom css file:', e);
          });
      },
      turnOff() {
        var e;
        null == (e = document.getElementById(Ds)) || e.remove();
      },
    };
  function qs(e) {
    const t = yo();
      ...
      custom: {
        ...
        onConfirm(e) {
          e
            ...
            : ((window.QueUp.room.chat.mentionChatSound.url = Bs),
              (Uo.options[Vs.id] = !1));
        },
      },
      turnOn() {
        ((Bs = window.QueUp.room.chat.mentionChatSound.url),
          Uo.custom[this.id] &&
            (window.QueUp.room.chat.mentionChatSound.url = Uo.custom[this.id]));
      },
      turnOff() {
        window.QueUp.room.chat.mentionChatSound.url = Bs;
      },
  ...
  function Js() {
    if (Uo.options.afk)
      Hn('auto-afk timer expired, but afk is already enabled');
    else {
      Hn('auto-afk timer expired, enabling afk');
      const e = document.querySelector('#dubplus-afk [role=switch]');
      null == e || e.click();
    }
  }
  function Ks() {
    let e = parseInt(Uo.custom['auto-afk'], 10);
    (isNaN(e) && (e = 30),
      Hn('auto-afk onBlur: starting timer for ', e, 'minutes'),
      (Ws = setTimeout(Js, 60 * e * 1e3)));
  }
  function Hs() {
    Ws
      ? (Hn('auto-afk onFocus: clearing timer'), clearTimeout(Ws), (Ws = null))
      : Hn('auto-afk onFocus: no timer to clear');
  }
  const Ys = {
    id: 'auto-afk',
    ...
    turnOn() {
      var e, t;
      ((t = Ks), (e = Hs) && Bi.push(e), t && Fi.push(t));
    },
    turnOff() {
      var e, t;
      ((t = Ks),
        (e = Hs) && Bi.splice(Bi.indexOf(e), 1),
        t && Fi.splice(Fi.indexOf(t), 1),
        Hs());
    },
    custom: {
  ...
  function Xs(e) {
    if (e.user._id === window.QueUp.session.id) {
      const e = Uo.custom['grab-response'];
      e && pi(e);
    }
  }
  const Gs = {
      ...
      category: 'general',
      turnOn() {
        window.QueUp.Events.bind(ii, Xs);
      },
      turnOff() {
        window.QueUp.Events.unbind(ii, Xs);
      },
      custom: {
    ...
    Zs = 'dubplus-collapsed',
    er = 'dubplus-collapsible-image',
    tr = 'dubplus-collapser';
  function nr(e) {
    e.target instanceof HTMLButtonElement &&
      ...
      (function (e) {
        ...
        t.classList.contains(Zs)
          ? (t.classList.remove(Zs),
            (e.title = 'collapse image'),
            n.setAttribute('aria-hidden', 'false'),
            e.setAttribute('aria-expanded', 'true'))
          : (t.classList.add(Zs),
            (e.title = 'expand image'),
            n.setAttribute('aria-hidden', 'true'),
            e.setAttribute('aria-expanded', 'false'));
      })(e.target));
  }
  function or(e) {
    if (e && !e.classList.contains(er)) {
      e.classList.add(er);
  ...
  function ir(e) {
    const t = e.querySelectorAll('.autolink-image');
    return Array.from(t).filter((e) => !e.classList.contains(er));
  }
  function sr(e) {
    for (const t of e)
      if ('childList' === t.type && t.target.nodeType === Node.ELEMENT_NODE) {
        const e = t.target;
  ...
  const ar = {
    ...
    category: 'general',
    turnOn() {
      ((rr = new MutationObserver(sr)),
        Gn(() => Boolean(bo())).then(() => {
          const e = bo();
          e
            ? (e.addEventListener('click', nr),
              rr.observe(e, { childList: !0, subtree: !0, attributes: !1 }))
            : Yn('Collapsible Images: No chat container found');
        }),
        Gn(() => Boolean(wo().length)).then(() => {
          wo().forEach(or);
        }));
    },
    turnOff() {
      var e;
      (rr && rr.disconnect(),
        null == (e = bo()) || e.removeEventListener('click', nr),
        document.querySelectorAll(`.${er}`).forEach((e) => {
          e.classList.remove(er, Zs);
        }),
        document.querySelectorAll(`.${tr}`).forEach((e) => {
          e.remove();
        }),
        wo().forEach((e) => e.removeAttribute('aria-hidden')));
    },
  };
  var lr = wn(
  ...
  const ur = {
      ...
      category: 'user-interface',
      turnOn() {
        const e = Uo.custom[this.id] || 'right';
      ...
      secondaryAction: {
        ...
        onClick: () => {
          const e = 'left' === (Uo.custom[ur.id] || 'right') ? 'right' : 'left';
  ...
  function hr(e, t) {
    ...
    function o() {
      var e, t;
      const n = null == (e = ko()) ? void 0 : e.textContent;
    ...
    ($n(
      ...
      ft(() => {
        (jn(i, 'aria-label', Xt(n)), jn(i, 'data-dp-tooltip', Xt(n)));
      }),
      pn('mouseenter', i, () => {
        Je(n, o(), !0);
      }),
  ...
  function yr(e, t) {
    (de(t, !0),
      ct(() => {
        if (Ei.emojiList.length > 0 && 'number' == typeof Ei.selectedIndex) {
        ...
        (ft(
          (e) => {
            ((s = In(
              ...
              jn(i, 'title', Xt(t).text),
              jn(a, 'src', Xt(t).src),
              jn(a, 'alt', o()),
              jn(a, 'title', o()));
          },
          [() => ({ selected: Xt(n) === Ei.selectedIndex })],
        ),
          xn(e, i));
      },
    );
      ...
      ft(
        (e, t, i, s, a) => {
          ...
          ((o = In(n, 0, 'ac-preview-container svelte-198qtio', null, o, e)),
            ...
            En(
              m,
              null == (u = Ei.emojiList[Ei.selectedIndex]) ? void 0 : u.text,
            ));
        },
        [
          () => ({ 'ac-show': Ei.emojiList.length > 0 }),
  ...
  var kr = (e, t, n) => t(Xt(n).username),
    ...
    Er = bn('<li><!></li>'),
    _r = bn('<div role="none"><ul id="dubinfo-preview"><!></ul></div>');
  function Sr(e, t) {
    de(t, !0);
    let n = Ee(() => {
    ...
    function a() {
      ...
      if (e) {
        ...
        (Je(o, window.innerWidth - t.right),
          Je(i, t.height - 2),
          Je(s, 'block'));
      } else Yn(`Could not find hover target for ${t.dubType} in onHover`);
    }
    function l(e) {
    ...
    (Rn(() => {
      ...
      e
        ...
        : Yn(`Could not find hover target for ${t.dubType} in onMount`);
    }),
      Wn(() => {
        const e = r();
        e
          ...
          : Yn(`Could not find hover target for ${t.dubType} in onDestroy`);
      }));
    var c = _r(),
      d = st(c);
    let p;
      ...
      m = (e) => {
        ...
        (Cn(
          ...
          (e, t) => {
            ...
            (ft(
              (e) => {
                (jn(i, 'src', e), En(r, `@${Xt(t).username ?? ''}`));
              },
              [
                () => {
                  return ((e = Xt(t).userid), `${ns}/user/${e}/image`);
                  var e;
                },
              ],
            ),
    ...
    (On(f, (e) => {
      ...
      ft(
        (e) => {
          (jn(c, 'id', `dubplus-${t.dubType}s-container`),
            In(
              c,
              0,
  ...
  function $r() {
    (!(function () {
      ...
      const t = Ur();
      Or = Number(
        (null == (e = null == t ? void 0 : t.dataset) ? void 0 : e.count) || Or,
      );
    })(),
      (function (e = 200) {
        let t = '';
  ...
  var Ar = bn('<div id="snow-container" class="svelte-qgqre1"></div>');
  var Ir = bn(
    ...
    qr =
      ...
      function () {
        return 1 === arguments.length
          ? (Je(jr, Xt(jr) + 1), arguments[0])
          : (Xt(jr), Dr());
      }),
    Pr = bn('<!> <!>', 1);
  var Fr = bn('<!> <!>', 1);
  function Br(e, t, n, o, i, s) {
  ...
  function Jr(e, t) {
    ...
    !(function (e, t) {
      ...
      function i() {
        (window.QueUp.room.player.setVolume(o.currentVol),
          ...
          window.QueUp.Events.unbind(ri, s));
      }
      function s(e) {
      ...
      ((r.__click = function () {
        ...
        ft(() => {
          (jn(r, 'aria-label', Xt(n)), jn(r, 'data-dp-tooltip', Xt(n)));
        }),
        xn(e, r),
        pe());
    })(o, {});
    ...
    !(function (e, t) {
      ...
      function s() {
        (Je(o, oo('SnoozeVideo.tooltip'), !0),
          ...
          window.QueUp.Events.unbind(ri, r));
      }
      function r(e) {
        if (e.startTime < 2) return (s(), !0);
      }
      var a = Vr();
      ((a.__click = [Br, i, o, n, r, s]),
        $n(
          a,
          (e, t) => (null == vo ? void 0 : vo(e, t)),
          () => ({ to: xo }),
        ...
        ft(() => {
          (In(
            ...
            jn(a, 'aria-label', Xt(o)),
            jn(a, 'data-dp-tooltip', Xt(o)));
        }),
        xn(e, a),
        pe());
    })(r, {});
    ...
    var u = at(a, 2),
      c = (e) => {
        ...
        Sr(n, { dubType: 'updub' });
        var o = at(n, 2);
        (Sr(o, { dubType: 'downdub' }),
          Sr(at(o, 2), { dubType: 'grab' }),
          xn(e, t));
      };
    On(u, (e) => {
      Uo.options['dubs-hover'] && e(c);
    });
    var d = at(u, 2),
      p = (e) => {
        !(function (e, t) {
    ...
    !(function (e, t) {
      (de(t, !1),
        pr.forEach((e) => {
          qr().options[e.id] || qr((qr().options[e.id] = !1));
        }),
        Bn());
      var n = Pr(),
        o = rt(n);
  ...
  const Kr = 'dubplusExtensionLoaded' in window;
  var Hr, Yr;
  (Hn('Dub+: loaded as extension:', Kr),
    Kr ||
      ((Hr = '/dubplus.css'),
      (Yr = 'dubplus-css'),
      (Hr = Hr.replace(/^\//, '')),
      new Promise((e, t) => {
        var n;
        null == (n = document.querySelector(`link.${Yr}`)) || n.remove();
        const o = zs;
        let i = 'DubPlus';
        'main' !== 'master'.trim() &&
          'master' !== 'master'.trim() &&
        ...
        })(Yr, `//cdn.jsdelivr.net/gh/DubPlus/${i}/${Hr}?${o}`);
        ((s.onload = () => e()), (s.onerror = t), document.head.appendChild(s));
      })).catch((e) => {
        Yn('Failed to load dubplus.css', e);
      }));
  let Xr = document.getElementById('dubplus-container');
  Xr
    ? Xr.children.length > 0 &&
      (!(function (e, t) {
        const n = Sn.get(e);
      ...
      (Gn(function () {
        return (function (e, t = window) {
          ...
          for (let t = 0; t < e.length; t++)
            if (!Xn(e[t], n)) return (Hn(e[t], 'is not found yet'), !1);
          return !0;
        })(o);
      })
        .then(() => {
        ...
        ct(() => {
          'loggedout' === Xt(n)
            ? i(oo('Error.modal.loggedout'))
            : 'error' === Xt(n) && i(oo('Error.unknown'));
        }));
      var s = kn(),
        r = rt(s),
        a = (e) => {
