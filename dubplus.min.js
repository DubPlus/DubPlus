...
"use strict";var myModule={};myModule.id="dubplus-hide-bg",myModule.moduleName="Hide Background",myModule.description="Toggle hiding background image.",myModule.category="User Interface",myModule.init=function(){this.optionState&&$("body").addClass("dubplus-hide-bg")},myModule.go=function(){var a;this.optionState?(a=!1,$("body").removeClass("dubplus-hide-bg")):(a=!0,$("body").addClass("dubplus-hide-bg")),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;
...
"use strict";var _notify=require("../utils/notify.js"),myModule={};myModule.id="dubplus_pm_notifications",myModule.moduleName="Notification on PM",myModule.description="Enable desktop notifications when a user receives a private message",myModule.category="General",myModule.pmNotify=function(a){var b=Dubtrack.session.get("_id");b===a.userid||(0,_notify.showNotification)({title:"You have a new PM",ignoreActiveTab:!0,callback:function callback(){$(".user-messages").click(),setTimeout(function(){$(".message-item[data-messageid=\""+a.messageid+"\"]").click()},500)},wait:1e4})},myModule.start=function(){var a=this;(0,_notify.notifyCheckPermission)(function(b){!0===b?Dubtrack.Events.bind("realtime:new-message",a.pmNotify):a.toggleAndSave(a.id,!1)})},myModule.init=function(){!0===this.optionState&&this.start()},myModule.go=function(){var a;this.optionState?(Dubtrack.Events.unbind("realtime:new-message",this.pmNotify),a=!1):(this.start(),a=!0),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{"../utils/notify.js":41}],28:[function(require,module,exports){
"use strict";var menu=require("../lib/menu.js"),rain={};rain.id="dubplus-rain",rain.moduleName="Rain",rain.description="Make it rain!",rain.optionState=!1,rain.category="General",rain.menuHTML=menu.makeOptionMenu(rain.moduleName,{id:rain.id,desc:rain.description}),rain.particles=[],rain.drops=[],rain.numbase=5,rain.numb=2,rain.width,rain.height=0,rain.controls={rain:2,alpha:1,color:200,opacity:1,saturation:100,lightness:50,back:0,multi:!1,speed:1},rain.init=function(){this.optionState&&($("body").prepend("<canvas id=\"dubPlusRainCanvas\" style=\"position : fixed; top : 0px; left : 0px; z-index: 100; pointer-events:none;\"></canvas>"),this.bindCanvas())},rain.go=function(){var b;this.optionState?(b=!1,$("#dubPlusRainCanvas").remove(),this.unbindCanvas()):(b=!0,$("body").prepend("<canvas id=\"dubPlusRainCanvas\" style=\"position : fixed; top : 0px; left : 0px; z-index: 100; pointer-events:none;\"></canvas>"),this.bindCanvas()),this.optionState=b,this.toggleAndSave(this.id,b)},rain.bindCanvas=function(){this.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(f){window.setTimeout(f,1e3/60)}}();var b=document.getElementById("dubPlusRainCanvas");if(b){var c=b.getContext("2d");this.width,this.height=0,window.onresize=function(){this.width=b.width=window.innerWidth,this.height=b.height=window.innerHeight},window.onresize(),this.particles,this.drops=[],this.numbase=5,this.numb=2;var d=this;(function f(){d.requestAnimFrame(f),d.update(),d.rendu(c)})()}},rain.buildRainParticle=function(a,b,c){for(c||(c=this.numb);c--;)this.particles.push({speedX:0.25*Math.random(),speedY:9*Math.random()+1,X:a,Y:b,alpha:1,color:"hsla("+this.controls.color+","+this.controls.saturation+"%, "+this.controls.lightness+"%,"+this.controls.opacity+")"})},rain.explosion=function(a,b,c,d){for(d||(d=this.numbase);d--;)this.drops.push({speedX:4*Math.random()-2,speedY:-4*Math.random(),X:a,Y:b,radius:0.65+Math.floor(1.6*Math.random()),alpha:1,color:c})},rain.rendu=function(a){!0==this.controls.multi&&(this.controls.color=360*Math.random()),a.save(),a.clearRect(0,0,width,height);for(var g,b=this.particles,c=this.drops,d=2*Math.PI,f=0;g=b[f];f++)a.globalAlpha=g.alpha,a.fillStyle=g.color,a.fillRect(g.X,g.Y,g.speedY/4,g.speedY);for(var h,f=0;h=c[f];f++)a.globalAlpha=h.alpha,a.fillStyle=h.color,a.beginPath(),a.arc(h.X,h.Y,h.radius,0,d),a.fill();a.strokeStyle="white",a.lineWidth=2,a.restore()},rain.update=function(){for(var d,a=this.particles,b=this.drops,c=0;d=a[c];c++)d.X+=d.speedX,d.Y+=d.speedY+5,d.Y>height-15&&(a.splice(c--,1),this.explosion(d.X,d.Y,d.color));for(var f,c=0;f=b[c];c++)f.X+=f.speedX,f.Y+=f.speedY,f.radius-=0.075,0<f.alpha?f.alpha-=5e-3:f.alpha=0,0>f.radius&&b.splice(c--,1);for(var c=this.controls.rain;c--;)this.buildRainParticle(Math.floor(Math.random()*width),-15)},rain.unbindCanvas=function(){this.requestAnimFrame=function(){}},module.exports=rain;
...
"use strict";var menu=require("../lib/menu.js");module.exports={id:"dubplus-snow",moduleName:"Snow",description:"Make it snow!",category:"General",doSnow:function doSnow(){$(document).snowfall({round:!0,shadow:!0,flakeCount:50,minSize:1,maxSize:5,minSpeed:5,maxSpeed:5})},start:function start(){var a=this;$.snowfall?this.doSnow():$.getScript("https://rawgit.com/loktar00/JQuery-Snowfall/master/src/snowfall.jquery.js").done(function(){a.doSnow()}).fail(function(b,c,d){console.error("Could not load snowfall jquery plugin",d)})},init:function init(){this.optionState&&this.start()},go:function go(){var b;this.optionState?(b=!1,$(document).snowfall("clear")):(b=!0,this.start()),this.optionState=b,this.toggleAndSave(this.id,b)}};
