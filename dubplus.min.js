...
'use strict';var updateChatInput=function(a){var b=$('#chat-txt-message').val(),f=b.split(' ').map(function(g){var k=a.toLowerCase(),l=g.toLowerCase();return 0===k.indexOf(l)?a:g});$('#autocomplete-preview').empty().removeClass('ac-show'),$('#chat-txt-message').val(f.join(' ')+' ').focus()},doNavigate=function(a){var b=$('.preview-item.selected').index();b+=a;var f=$('.ac-show li');$('.ac-list-press-enter').remove(),b>=f.length&&(b=0),0>b&&(b=f.length-1);var g='selected';f.removeClass(g).eq(b).addClass(g).append('<span class="ac-list-press-enter">press enter to select</span>'),$('.preview-item.selected').get(0).scrollIntoView(!1)},previewListKeyUp=function(a){switch(a.preventDefault(),a.keyCode){case 38:doNavigate(-1);break;case 40:doNavigate(1);break;case 39:case 13:var b=$('#autocomplete-preview li.selected').find('.ac-text')[0].textContent;updateChatInput(b);break;default:$('#chat-txt-message').focus();}},display=function(a){function b(l){var m=document.createElement('li');return m.className=l,m}function f(l,m){var n=document.createElement('img');n.src=l,m&&(n.title=m,n.alt=m);var o=document.createElement('div');return o.className='ac-image',o.appendChild(n),o}function g(l){var m=document.createElement('span');return m.textContent=l,m.className='ac-text',m}function h(l){var o,m=b('preview-item '+l.cn+'-previews'),n=g(l.text);return o=l.alt?f(l.src,l.alt):f(l.src),m.appendChild(o),m.appendChild(n),m.tabIndex=-1,m}var j=document.getElementById('autocomplete-preview');j.innerHTML='';var k=document.createDocumentFragment();a.forEach(function(l){k.appendChild(h(l))}),j.appendChild(k),j.classList.add('ac-show')},updater=function(){var b=$(this).find('.ac-text')[0].textContent;updateChatInput(b)},init=function(){var a=document.createElement('ul');a.id='autocomplete-preview',$('.pusher-chat-widget-input').prepend(a),$(document.body).on('click','.preview-item',updater),$(document.body).on('keyup','.ac-show',previewListKeyUp)},stop=function(){$(document.body).off('click','.preview-item',updater),$(document.body).off('keyup','.ac-show',previewListKeyUp),$('#autocomplete-preview').remove()};module.exports={init:init,stop:stop,display:display,updateChatInput:updateChatInput,doNavigate:doNavigate};

},{}],4:[function(require,module,exports){
'use strict';var _loadModules=require('./loadModules.js'),_loadModules2=_interopRequireDefault(_loadModules),_snooze=require('../modules/snooze.js'),_snooze2=_interopRequireDefault(_snooze),_eta=require('../modules/eta.js'),_eta2=_interopRequireDefault(_eta);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}var css=require('../utils/css.js'),menu=require('./menu.js');module.exports=function(){css.load('/css/dubplus.css'),$('html').addClass('dubplus'),$.getScript('https://rawgit.com/loktar00/JQuery-Snowfall/master/src/snowfall.jquery.js');var a=menu.beginMenu(),b=(0,_loadModules2.default)();menu.finishMenu(b,a),(0,_snooze2.default)(),(0,_eta2.default)(),$('.dubplus-menu').perfectScrollbar()};

},{"../modules/eta.js":18,"../modules/snooze.js":28,"../utils/css.js":34,"./loadModules.js":5,"./menu.js":6}],5:[function(require,module,exports){
(function (PKGINFO){
'use strict';Object.defineProperty(exports,'__esModule',{value:!0});var options=require('../utils/options.js'),dubPlus_modules=require('../modules/index.js'),settings=require('../lib/settings.js'),menu=require('../lib/menu.js'),menuObj={General:'','User Interface':'',Settings:'',Customize:''},loadAllModules=function(){return window.dubplus=JSON.parse(PKGINFO),dubPlus_modules.forEach(function(a){window.dubplus[a.id]=a,window.dubplus[a.id].toggleAndSave=options.toggleAndSave,('function'==typeof a.go||'function'==typeof a.extra)&&$('body').on('click','#'+a.id,function(c){c.target.classList.contains('extra-icon')&&'function'==typeof a.extra?a.extra.call(a):a.go&&a.go.call(a)}),a.optionState=settings.options[a.id]||!1,'function'==typeof a.init&&a.init.bind(a)();var b=null;'function'!=typeof a.extra||a.extraIcon||(b='pencil'),menuObj[a.category]+=menu.makeOptionMenu(a.moduleName,{id:a.id,desc:a.description,state:a.optionState,extraIcon:a.extraIcon||b,cssClass:a.menuCssClass||'',altIcon:a.altIcon||null})}),menuObj};exports.default=loadAllModules;
...
'use strict';var modal=require('../utils/modal.js'),options=require('../utils/options.js'),settings=require('../lib/settings.js'),afk_module={};afk_module.id='dubplus-afk',afk_module.moduleName='AFK Auto-respond',afk_module.description='Toggle Away from Keyboard and customize AFK message.',afk_module.category='General';var afk_chat_respond=function(a){var b=a.message,c=Dubtrack.session.get('username');if(-1<b.indexOf('@'+c)&&Dubtrack.session.id!==a.user.userInfo.userid){settings.custom.customAfkMessage?$('#chat-txt-message').val('[AFK] '+settings.custom.customAfkMessage):$('#chat-txt-message').val('[AFK] I\'m not here right now.'),Dubtrack.room.chat.sendMessage(),this.optionState=!1;var d=this;setTimeout(function(){d.optionState=!0},1.8e5)}};afk_module.init=function(){!0===this.optionState&&Dubtrack.Events.bind('realtime:chat-message',afk_chat_respond)},afk_module.go=function(){var b;this.optionState?(b=!1,Dubtrack.Events.unbind('realtime:chat-message',afk_chat_respond)):(b=!0,Dubtrack.Events.bind('realtime:chat-message',afk_chat_respond)),this.optionState=b,this.toggleAndSave(this.id,b)};var saveAFKmessage=function(){var a=$('.dp-modal textarea').val();''!==a&&options.saveOption('custom','customAfkMessage',a)};afk_module.extra=function(){modal.create({title:'Custom AFK Message',content:'Enter a custom Away From Keyboard [AFK] message here',value:settings.custom.customAfkMessage||'',placeholder:'Be right back!',maxlength:'255',confirmCallback:saveAFKmessage})},module.exports=afk_module;

},{"../lib/settings.js":7,"../utils/modal.js":36,"../utils/options.js":38}],9:[function(require,module,exports){
'use strict';var previewList=require('../emojiUtils/previewList.js'),settings=require('../lib/settings.js'),prepEmjoji=require('../emojiUtils/prepEmoji.js'),myModule={};myModule.id='dubplus-autocomplete',myModule.moduleName='Autocomplete Emoji',myModule.description='Toggle autocompleting emojis and emotes.  Shows a preview box in the chat',myModule.category='General';var previewSearchStr='',emojiUtils={createPreviewObj:function createPreviewObj(a,b,c){return{src:prepEmjoji[a].template(b),text:':'+c+':',alt:c,cn:a}},addToPreviewList:function addToPreviewList(a){var b=this,c=[],d;a.forEach(function(f){d=f.toLowerCase(),'undefined'!=typeof prepEmjoji.twitch.emotes[d]&&c.push(b.createPreviewObj('twitch',prepEmjoji.twitch.emotes[d],f)),'undefined'!=typeof prepEmjoji.bttv.emotes[d]&&c.push(b.createPreviewObj('bttv',prepEmjoji.bttv.emotes[d],f)),'undefined'!=typeof prepEmjoji.tasty.emotes[d]&&c.push(b.createPreviewObj('tasty',d,f)),0<=emojify.emojiNames.indexOf(d)&&c.push(b.createPreviewObj('emoji',f,f))}),previewList.display(c)},filterEmoji:function filterEmoji(a){var b=a.replace(/([+()])/,'\\$1'),c=new RegExp('^'+b,'i'),d=emojify.emojiNames;return settings.options['dubplus-emotes']&&(d=prepEmjoji.emojiEmotes),d.filter(function(f){return c.test(f)})}},chatInputKeyupFunc=function(a){if(38===a.keyCode)return void previewList.doNavigate(-1);if(40===a.keyCode)return void previewList.doNavigate(1);var f,g,b=this.value,c=3,d=$(this).get(0).selectionStart,h=/(:|@)([&!()\+\-_a-z0-9]+)($|\s)/ig;b.replace(h,function(l,m,n,o,p){f=p,g=p+l.length,previewSearchStr=n,d>=f&&d<=g&&n&&n.length>=c&&':'===m&&emojiUtils.addToPreviewList(emojiUtils.filterEmoji(n))});var i=b.charAt(b.length-1);if((previewSearchStr.length<c||':'===i||' '===i||''===b)&&(previewSearchStr='',$('#autocomplete-preview').empty().removeClass('ac-show')),!$('.ac-show li:first-child').find('.ac-list-press-enter').length){$('.ac-show li:first-child').append('<span class="ac-list-press-enter">press enter to select</span>').addClass('selected')}if(13===a.keyCode&&0<$('#autocomplete-preview li').length){var k=$('#autocomplete-preview li.selected').find('.ac-text')[0].textContent;return void previewList.updateChatInput(k)}13===a.keyCode&&0<b.length&&Dubtrack.room.chat.sendMessage()},chatInputKeydownFunc=function(a){if(_.includes([9,13,38,40],a.keyCode)&&0===$('.ac-show').length)return Dubtrack.room.chat.ncKeyDown({which:a.keyCode})};myModule.start=function(){previewList.init(),Dubtrack.room.chat.delegateEvents(_(Dubtrack.room.chat.events).omit('keydown #chat-txt-message')),$(document.body).on('keydown','#chat-txt-message',chatInputKeydownFunc),$(document.body).on('keyup','#chat-txt-message',chatInputKeyupFunc)},myModule.init=function(){this.optionState&&this.start()},myModule.go=function(){var a;this.optionState?(previewList.stop(),a=!1,$(document.body).off('keydown','#chat-txt-message',chatInputKeydownFunc),$(document.body).off('keyup','#chat-txt-message',chatInputKeyupFunc)):(a=!0,this.start()),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{"../emojiUtils/prepEmoji.js":2,"../emojiUtils/previewList.js":3,"../lib/settings.js":7}],10:[function(require,module,exports){
"use strict";var autovote={id:"dubplus-autovote",moduleName:"Autovote",description:"Toggles auto upvoting for every song",category:"General"},advance_vote=function(){$(".dubup").click()},voteCheck=function(a){2>a.startTime&&advance_vote()};autovote.init=function(){!0===this.optionState&&this.start()},autovote.go=function(){var a;this.optionState?(a=!1,Dubtrack.Events.unbind("realtime:room_playlist-update",voteCheck)):(a=!0,this.start()),this.optionState=a,this.toggleAndSave(this.id,a)},autovote.start=function(){var a=Dubtrack.room.player.activeSong.get("song"),b=Dubtrack.helpers.cookie.get("dub-"+Dubtrack.room.model.get("_id")),c=Dubtrack.helpers.cookie.get("dub-song");Dubtrack.room&&a&&a.songid===c||(b=!1),$(".dubup, .dubdown").hasClass("voted")||b||advance_vote(),Dubtrack.Events.bind("realtime:room_playlist-update",voteCheck)},module.exports=autovote;

},{}],11:[function(require,module,exports){
"use strict";var css=require("../utils/css.js"),myModule={};myModule.id="dubplus-comm-theme",myModule.moduleName="Community Theme",myModule.description="Toggle Community CSS theme.",myModule.category="Customize",myModule.start=function(){var a=Dubtrack.room.model.get("roomUrl");$.ajax({type:"GET",url:"https://api.dubtrack.fm/room/"+a}).done(function(b){var c=b.data.description,d=new RegExp(/(@dub[x|plus]=)((https?:\/\/)?[\w-]+(\.[\w-]+)+\.?(:\d+)?(\/\S*)?)/,"i"),f=null;c.replace(d,function(g,h,i){console.log("loading community css theme:",i),f=i});f&&css.loadExternal(f,"dubplus-comm-theme")})},myModule.init=function(){this.optionState&&this.start()},myModule.go=function(){var a;this.optionState?(a=!1,$(".dubplus-comm-theme").remove()):(a=!0,this.start()),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{"../utils/css.js":34}],12:[function(require,module,exports){
'use strict';var settings=require('../lib/settings.js'),modal=require('../utils/modal.js'),options=require('../utils/options.js'),myModule={};myModule.id='dubplus-custom-bg',myModule.moduleName='Custom Background',myModule.description='Add your own custom background.',myModule.category='Customize',myModule.extraIcon='pencil';var makeBGdiv=function(a){return'<div class="dubplus-custom-bg" style="background-image: url('+a+');"></div>'},saveCustomBG=function(){var a=$('.dp-modal textarea').val();return''!==a&&a?void($('.dubplus-custom-bg').length?$('.dubplus-custom-bg').css('background-image','url('+a+')'):$('body').append(makeBGdiv(a)),options.saveOption('custom','bg',a)):($('.dubplus-custom-bg').remove(),void options.saveOption('custom','bg',''))};myModule.extra=function(){modal.create({title:'Custom Background Image',content:'Enter the full URL of an image. We recommend using a .jpg file. Leave blank to remove the current background image',value:settings.custom.bg||'',placeholder:'https://example.com/big-image.jpg',maxlength:'500',confirmCallback:saveCustomBG})},myModule.addBG=function(){settings.custom.bg&&''!==settings.custom.bg?$('body').append(makeBGdiv(settings.custom.bg)):this.extra()},myModule.init=function(){this.optionState&&this.addBG()},myModule.go=function(){var a;this.optionState?(a=!1,$('.dubplus-custom-bg').remove()):(a=!0,this.addBG()),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{"../lib/settings.js":7,"../utils/modal.js":36,"../utils/options.js":38}],13:[function(require,module,exports){
'use strict';var css=require('../utils/css.js'),settings=require('../lib/settings.js'),modal=require('../utils/modal.js'),options=require('../utils/options.js'),myModule={};myModule.id='dubplus-custom-css',myModule.moduleName='Custom CSS',myModule.description='Add your own custom CSS.',myModule.category='Customize',myModule.extraIcon='pencil',myModule.init=function(){this.optionState&&css.loadExternal(settings.custom.css,'dubplus-custom-css')};var css_import=function(){$('.dubplus-custom-css').remove();var a=$('.dp-modal textarea').val();options.saveOption('custom','css',a),a&&''!==a&&css.loadExternal(a,'dubplus-custom-css')};myModule.extra=function(){modal.create({title:'Custom CSS',content:'Enter a url location for your custom css',value:settings.custom.css||'',placeholder:'https://example.com/example.css',maxlength:'500',confirmCallback:css_import})},myModule.go=function(){var a;this.optionState?(a=!1,$('.dubplus-custom-css').remove()):(a=!0,settings.custom.css&&''!==settings.custom.css?css.loadExternal(settings.custom.css,'dubplus-custom-css'):this.extra()),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{"../lib/settings.js":7,"../utils/css.js":34,"../utils/modal.js":36,"../utils/options.js":38}],14:[function(require,module,exports){
'use strict';var settings=require('../lib/settings.js'),modal=require('../utils/modal.js'),options=require('../utils/options.js'),myModule={};myModule.id='custom_mentions',myModule.moduleName='Custom Mentions',myModule.description='Toggle using custom mentions to trigger sounds in chat',myModule.category='General',myModule.extraIcon='pencil';var saveCustomMentions=function(){var a=$('.dp-modal textarea').val();''!==a&&options.saveOption('custom','custom_mentions',a)};myModule.customMentionCheck=function(a){var b=a.message.toLowerCase();if(settings.custom.custom_mentions){var c=settings.custom.custom_mentions.toLowerCase().split(','),d=c.some(function(f){return 0<=b.indexOf(f.trim(' '))});Dubtrack.session.id!==a.user.userInfo.userid&&d&&Dubtrack.room.chat.mentionChatSound.play()}},myModule.start=function(){Dubtrack.Events.bind('realtime:chat-message',this.customMentionCheck)},myModule.init=function(){!0===this.optionState&&this.start()},myModule.extra=function(){modal.create({title:'Custom AFK Message',content:'Custom Mention Triggers (separate by comma)',value:settings.custom.custom_mentions||'',placeholder:'separate, custom triggers, by, comma, :heart:',maxlength:'255',confirmCallback:saveCustomMentions})},myModule.go=function(){var a;this.optionState?(Dubtrack.Events.unbind('realtime:chat-message',this.customMentionCheck),a=!1):(this.start(),a=!0),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{"../lib/settings.js":7,"../utils/modal.js":36,"../utils/options.js":38}],15:[function(require,module,exports){
"use strict";var settings=require("../lib/settings.js"),modal=require("../utils/modal.js"),myModule={};myModule.id="mention_notifications",myModule.moduleName="Notification on Mentions",myModule.description="Enable desktop notifications when a user mentions you in chat",myModule.category="General",myModule.notifyOnMention=function(a){var b=a.message,c=Dubtrack.session.get("username").toLowerCase(),d=["@"+c];settings.options.custom_mentions&&settings.custom.custom_mentions&&(d=d.concat(settings.custom.custom_mentions.toLowerCase().split(",")));var f=d.some(function(i){return 0<=b.toLowerCase().indexOf(i.trim(" "))});if(f&&!this.isActiveTab&&Dubtrack.session.id!==a.user.userInfo.userid){var h=new Notification("Message from "+a.user.username,{body:b,icon:"https://res.cloudinary.com/hhberclba/image/upload/c_lpad,h_100,w_100/v1400351432/dubtrack_new_logo_fvpxa6.png"});h.onclick=function(){window.focus(),h.close()},setTimeout(h.close.bind(h),5e3)}},myModule.mentionNotifications=function(){function a(c){"granted"===c&&(Dubtrack.Events.bind("realtime:chat-message",b.notifyOnMention),b.toggleAndSave(b.id,!0))}var b=this;this.isActiveTab=!0,window.onfocus=function(){b.isActiveTab=!0},window.onblur=function(){b.isActiveTab=!1},"Notification"in window?"granted"===Notification.permission?a("granted"):"denied"===Notification.permission?modal.create({title:"Mention Notifications",content:"You have chosen to block notifications. Reset this choice by clearing your cache for the site."}):Notification.requestPermission(a):modal.create({title:"Mention Notifications",content:"Sorry this browser does not support desktop notifications.  Please use the latest version of Chrome or FireFox"})},myModule.init=function(){!0===this.optionState&&myModule.mentionNotifications()},myModule.go=function(){var a;this.optionState?(Dubtrack.Events.unbind("realtime:chat-message",this.notifyOnMention),a=!1):(myModule.mentionNotifications(),a=!0),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{"../lib/settings.js":7,"../utils/modal.js":36}],16:[function(require,module,exports){
"use strict";var _modcheck=require("../utils/modcheck.js"),_modcheck2=_interopRequireDefault(_modcheck);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}var myModule={};myModule.id="dubplus-downdubs",myModule.moduleName="Downdubs in Chat (mods only)",myModule.description="Toggle showing downdubs in the chat box (mods only)",myModule.category="General",myModule.downdubWatcher=function(a){var b=Dubtrack.session.get("username"),c=Dubtrack.room.users.collection.findWhere({userid:Dubtrack.room.player.activeSong.attributes.song.userid}).attributes._user.username;if(b===c&&"downdub"===a.dubtype){var d="\n      <li class=\"dubplus-chat-system dubplus-chat-system-downdub\">\n        <div class=\"chatDelete\" onclick=\"dubplus.deleteChatMessageClientSide(this)\">\n          <span class=\"icon-close\"></span>\n        </div>\n        <div class=\"text\">\n          @"+a.user.username+" has downdubbed your song "+Dubtrack.room.player.activeSong.attributes.songInfo.name+"\n        </div>\n      </li>";$("ul.chat-main").append(d)}},myModule.start=function(){(0,_modcheck2.default)(Dubtrack.session.id)&&(Dubtrack.Events.bind("realtime:room_playlist-dub",this.downdubWatcher),"function"!=typeof window.dubplus.deleteChatMessageClientSide&&(window.dubplus.deleteChatMessageClientSide=function(a){$(a).parent("li")[0].remove()}))},myModule.init=function(){this.optionState&&this.start()},myModule.go=function(){var a;this.optionState?(a=!1,Dubtrack.Events.unbind("realtime:room_playlist-dub",this.downdubWatcher)):(a=!0,this.start()),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{"../utils/modcheck.js":37}],17:[function(require,module,exports){
"use strict";var dubplus_emoji=require("../emojiUtils/prepEmoji.js"),emote_module={};emote_module.id="dubplus-emotes",emote_module.moduleName="Emotes",emote_module.description="Adds twitch and bttv emotes in chat.",emote_module.category="General";function makeImage(a,b,c,d,e){return"<img class=\"emoji "+a+"-emote\" "+(d?"width=\""+d+"\" ":"")+(e?"height=\""+e+"\" ":"")+"title=\""+c+"\" alt=\""+c+"\" src=\""+b+"\" />"}var replaceTextWithEmote=function(){var a=dubplus_emoji.twitch.chatRegex;if(dubplus_emoji.twitchJSONSLoaded){var b=$(".chat-main .text").last();if(b.html()){dubplus_emoji.bttvJSONSLoaded&&(a=dubplus_emoji.bttv.chatRegex);var c=b.html().replace(a,function(d,e){var f,g,i=e.toLowerCase();return dubplus_emoji.twitch.emotes[i]?(f=dubplus_emoji.twitch.emotes[i],g=dubplus_emoji.twitch.template(f),makeImage("twitch",g,i)):dubplus_emoji.bttv.emotes[i]?(f=dubplus_emoji.bttv.emotes[i],g=dubplus_emoji.bttv.template(f),makeImage("bttv",g,i)):dubplus_emoji.tasty.emotes[i]?(g=dubplus_emoji.tasty.template(i),makeImage("tasty",g,i,dubplus_emoji.tasty.emotes[i].width,dubplus_emoji.tasty.emotes[i].height)):d});b.html(c)}}},startReplacing=function(){window.addEventListener("twitch:loaded",dubplus_emoji.loadBTTVEmotes.bind(dubplus_emoji)),dubplus_emoji.twitchJSONSLoaded?replaceTextWithEmote():dubplus_emoji.loadTwitchEmotes(),Dubtrack.Events.bind("realtime:chat-message",replaceTextWithEmote)};emote_module.init=function(){emote_module.optionState&&startReplacing()},emote_module.go=function(){var a;emote_module.optionState?(Dubtrack.Events.unbind("realtime:chat-message",replaceTextWithEmote),a=!1):(startReplacing(),a=!0),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=emote_module;
...
"use strict";var fs_module={};fs_module.id="dubplus-fullscreen",fs_module.moduleName="Fullscreen Video",fs_module.description="Toggle fullscreen video mode",fs_module.category="User Interface",fs_module.altIcon="arrows-alt",fs_module.go=function(){var b=document.querySelector(".playerElement iframe");b.requestFullscreen?b.requestFullscreen():b.msRequestFullscreen?b.msRequestFullscreen():b.mozRequestFullScreen?b.mozRequestFullScreen():b.webkitRequestFullscreen&&b.webkitRequestFullscreen()},module.exports=fs_module;

},{}],20:[function(require,module,exports){
"use strict";var myModule={};myModule.id="dubplus-grabschat",myModule.moduleName="Grabs in Chat",myModule.description="Toggle showing grabs in the chat box",myModule.category="General",myModule.grabChatWatcher=function(a){var b=Dubtrack.session.get("username"),c=Dubtrack.room.users.collection.findWhere({userid:Dubtrack.room.player.activeSong.attributes.song.userid}).attributes._user.username;if(b===c&&!Dubtrack.room.model.get("displayUserGrab")){var d="\n      <li class=\"dubplus-chat-system dubplus-chat-system-grab\">\n        <div class=\"chatDelete\" onclick=\"dubplus.deleteChatMessageClientSide(this)\">\n          <span class=\"icon-close\"></span>\n        </div>\n        <div class=\"text\">\n          @"+a.user.username+" has grabbed your song "+Dubtrack.room.player.activeSong.attributes.songInfo.name+"\n        </div>\n      </li>";$("ul.chat-main").append(d)}},myModule.start=function(){Dubtrack.Events.bind("realtime:room_playlist-queue-update-grabs",this.grabChatWatcher),"function"!=typeof window.dubplus.deleteChatMessageClientSide&&(window.dubplus.deleteChatMessageClientSide=function(a){$(a).parent("li")[0].remove()})},myModule.init=function(){this.optionState&&this.start()},myModule.go=function(){var a;this.optionState?(a=!1,Dubtrack.Events.unbind("realtime:room_playlist-queue-update-grabs",this.grabChatWatcher)):(a=!0,this.start()),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{}],21:[function(require,module,exports){
"use strict";var myModule={};myModule.id="dubplus-hide-avatars",myModule.moduleName="Hide Avatars",myModule.description="Toggle hiding user avatars in the chat box.",myModule.category="User Interface",myModule.init=function(){this.optionState&&$("body").addClass("dubplus-hide-avatars")},myModule.go=function(){var a;this.optionState?(a=!1,$("body").removeClass("dubplus-hide-avatars")):(a=!0,$("body").addClass("dubplus-hide-avatars")),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{}],22:[function(require,module,exports){
"use strict";var myModule={};myModule.id="dubplus-hide-bg",myModule.moduleName="Hide Background",myModule.description="Toggle hiding background image.",myModule.category="User Interface",myModule.init=function(){this.optionState&&($(".backstretch").hide(),$(".medium").hide())},myModule.go=function(){var a;this.optionState?(a=!1,$(".backstretch").show(),$(".medium").show()):(a=!0,$(".backstretch").hide(),$(".medium").hide()),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{}],23:[function(require,module,exports){
"use strict";var myModule={};myModule.id="dubplus-video-only",myModule.moduleName="Hide Chat",myModule.description="Toggles hiding the chat box",myModule.category="User Interface",myModule.init=function(){this.optionState&&$("body").addClass("dubplus-video-only")},myModule.go=function(){var a;this.optionState?(a=!1,$("body").removeClass("dubplus-video-only")):(a=!0,$("body").addClass("dubplus-video-only")),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{}],24:[function(require,module,exports){
"use strict";var myModule={};myModule.id="dubplus-chat-only",myModule.moduleName="Hide Video",myModule.description="Toggles hiding the video box",myModule.category="User Interface",myModule.init=function(){this.optionState&&$("body").addClass("dubplus-chat-only")},myModule.go=function(){var a;this.optionState?(a=!1,$("body").removeClass("dubplus-chat-only")):(a=!0,$("body").addClass("dubplus-chat-only")),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{}],25:[function(require,module,exports){
'use strict';module.exports=[require('./autovote.js'),require('./afk.js'),require('./emotes.js'),require('./autocomplete.js'),require('./customMentions.js'),require('./desktopNotifications.js'),require('./showDubsOnHover.js'),require('./downDubInChat.js'),require('./upDubInChat.js'),require('./grabsInChat.js'),require('./snow.js'),require('./fullscreen.js'),require('./splitchat.js'),require('./hideChat.js'),require('./hideVideo.js'),require('./hideAvatars.js'),require('./hideBackground.js'),require('./showTimestamps.js'),require('./spacebarMute.js'),require('./warnOnNavigation.js'),require('./communityTheme.js'),require('./customCSS.js'),require('./customBackground.js')];
...
"use strict";var menu=require("../lib/menu.js"),snow={};snow.id="dubplus-snow",snow.moduleName="Snow",snow.description="Make it snow!",snow.optionState=!1,snow.category="General",snow.menuHTML=menu.makeOptionMenu(snow.moduleName,{id:snow.id,desc:snow.description}),snow.go=function(){var b;this.optionState?(b=!1,$(document).snowfall("clear")):(b=!0,$(document).snowfall({round:!0,shadow:!0,flakeCount:50,minSize:1,maxSize:5,minSpeed:5,maxSpeed:5})),this.optionState=b,this.toggleAndSave(this.id,b)},module.exports=snow;

},{"../lib/menu.js":6}],30:[function(require,module,exports){
"use strict";var myModule={};myModule.id="dubplus-spacebar-mute",myModule.moduleName="Spacebar Mute",myModule.description="Turn on/off the ability to mute current song with the spacebar.",myModule.category="Settings",myModule.start=function(){$(document).bind("keypress.key32",function(a){var b=a.target.tagName.toLowerCase();32===a.which&&"input"!==b&&"textarea"!==b&&$("#main_player .player_sharing .player-controller-container .mute").click()})},myModule.init=function(){this.optionState&&this.start()},myModule.go=function(){var a;this.optionState?(a=!1,$(document).unbind("keypress.key32")):(a=!0,this.start()),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{}],31:[function(require,module,exports){
"use strict";var myModule={};myModule.id="dubplus-split-chat",myModule.moduleName="Split Chat",myModule.description="Toggle Split Chat UI enhancement",myModule.category="User Interface",myModule.init=function(){this.optionState&&$("body").addClass("dubplus-split-chat")},myModule.go=function(){var a;this.optionState?(a=!1,$("body").removeClass("dubplus-split-chat")):(a=!0,$("body").addClass("dubplus-split-chat")),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{}],32:[function(require,module,exports){
"use strict";var myModule={};myModule.id="dubplus-updubs",myModule.moduleName="Updubs in Chat",myModule.description="Toggle showing updubs in the chat box",myModule.category="General",myModule.updubWatcher=function(a){var b=Dubtrack.session.get("username"),c=Dubtrack.room.users.collection.findWhere({userid:Dubtrack.room.player.activeSong.attributes.song.userid}).attributes._user.username;if(b===c&&"updub"===a.dubtype){var d="\n      <li class=\"dubplus-chat-system dubplus-chat-system-updub\">\n        <div class=\"chatDelete\" onclick=\"dubplus.deleteChatMessageClientSide(this)\">\n          <span class=\"icon-close\"></span>\n        </div>\n        <div class=\"text\">\n          @"+a.user.username+" has updubbed your song "+Dubtrack.room.player.activeSong.attributes.songInfo.name+"\n        </div>\n      </li>";$("ul.chat-main").append(d)}},myModule.start=function(){Dubtrack.Events.bind("realtime:room_playlist-dub",this.updubWatcher),"function"!=typeof window.dubplus.deleteChatMessageClientSide&&(window.dubplus.deleteChatMessageClientSide=function(a){$(a).parent("li")[0].remove()})},myModule.init=function(){this.optionState&&this.start()},myModule.go=function(){var a;this.optionState?(a=!1,Dubtrack.Events.unbind("realtime:room_playlist-dub",this.updubWatcher)):(a=!0,this.start()),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;

},{}],33:[function(require,module,exports){
"use strict";var myModule={};myModule.id="warn_redirect",myModule.moduleName="Warn On Navigation",myModule.description="Warns you when accidentally clicking on a link that takes you out of dubtrack.",myModule.category="Settings",myModule.start=function(){window.onbeforeunload=function(){return""}},myModule.init=function(){this.optionState&&this.start()},myModule.go=function(){var a;this.optionState?(a=!1,window.onbeforeunload=null):(a=!0,this.start()),this.optionState=a,this.toggleAndSave(this.id,a)},module.exports=myModule;
