...
"use strict";var autovote={id:"dubplus-autovote",moduleName:"Autovote",description:"Toggles auto upvoting for every song",category:"General"},advance_vote=function(){console.log("voting"),Dubtrack.playerController.voteUp.click()},voteCheck=function(a){console.log("checking vote",a),2>a.startTime&&advance_vote()};autovote.turnOff=function(){Dubtrack.Events.unbind("realtime:room_playlist-update",voteCheck)},autovote.turnOn=function(){var a=Dubtrack.room.player.activeSong.get("song"),b=Dubtrack.helpers.cookie.get("dub-"+Dubtrack.room.model.get("_id")),c=Dubtrack.helpers.cookie.get("dub-song");Dubtrack.room&&a&&a.songid===c||(b=!1),$(".dubup, .dubdown").hasClass("voted")||b?console.log("turned on but not voting",$(".dubup, .dubdown").hasClass("voted"),b):advance_vote(),Dubtrack.Events.bind("realtime:room_playlist-update",voteCheck)},module.exports=autovote;
