...
'use strict';module.exports=[require('./autovote.js'),require('./afk.js'),require('./emotes.js'),require('./autocomplete.js'),require('./customMentions.js'),require('./chatNotifications.js'),require('./pmNotifications.js'),require('./queueNotification.js'),require('./showDubsOnHover.js'),require('./downDubInChat.js'),require('./upDubInChat.js'),require('./grabsInChat.js'),require('./snow.js'),require('./rain.js'),require('./fullscreen.js'),require('./splitchat.js'),require('./hideChat.js'),require('./hideVideo.js'),require('./hideAvatars.js'),require('./hideBackground.js'),require('./showTimestamps.js'),require('./spacebarMute.js'),require('./warnOnNavigation.js'),require('./communityTheme.js'),require('./customCSS.js'),require('./customBackground.js'),require('./customNotificationSound.js')];
...
'use strict';var _notify=require('../utils/notify.js'),settings=require('../lib/settings.js'),modal=require('../utils/modal.js'),options=require('../utils/options.js'),myModule={};myModule.id='queue-notification',myModule.moduleName='Queue Notification',myModule.description='Notification when you are coming up to be the DJ',myModule.category='General',myModule.extraIcon='pencil';var saveCustomMentions=function(){var a=parseInt($('.dp-modal textarea').val());isNaN(a)?options.saveOption('custom','queue_notification',2):options.saveOption('custom','queue_notification',a)};myModule.queueNotificationCheck=function(a){if(!(2<a.startTime)){var b=parseInt($('.queue-position').text());isNaN(b)||b!==settings.custom.queue_notification||((0,_notify.showNotification)({title:'DJ Alert!',content:'You will be DJing shortly! Make sure your song is set!',ignoreActiveTab:!0,wait:1e4}),Dubtrack.room.chat.mentionChatSound.play())}},myModule.turnOn=function(){Dubtrack.Events.bind('realtime:room_playlist-update',this.queueNotificationCheck)},myModule.extra=function(){modal.create({title:'Queue Notification',content:'Position in queue to notify at',value:settings.custom.queue_notification||'',placeholder:'2',maxlength:'2',confirmCallback:saveCustomMentions})},myModule.turnOff=function(){Dubtrack.Events.unbind('realtime:room_playlist-update',this.queueNotificationCheck)},module.exports=myModule;
