...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var options=require("../utils/options.js"),toggleMenuSection=function(a){var b=a.nextElementSibling,c=a.children[0],d=a.textContent.trim().replace(" ","-").toLowerCase(),e=b.classList.toggle("dubplus-menu-section-closed");e?(c.classList.remove("fa-angle-down"),c.classList.add("fa-angle-right"),options.saveOption("menu",d,"closed")):(c.classList.remove("fa-angle-right"),c.classList.add("fa-angle-down"),options.saveOption("menu",d,"open"))},traverseMenuDOM=function(a){if(!a||a.classList.contains("dubplus-menu"))return null;if(a.classList.contains("dubplus-menu-section-header"))return toggleMenuSection(a),null;var b=window.dubplus[a.id];return b?b:traverseMenuDOM(a.parentElement)},menuDelegator=function(a){var b=traverseMenuDOM(a.target);if(b){if(a.target.classList.contains("extra-icon")&&b.extra)return void b.extra.call(b);if(b.turnOn&&b.turnOff){var c;return b.optionState?(c=!1,b.turnOff.call(b)):(c=!0,b.turnOn.call(b)),b.optionState=c,void options.toggleAndSave(b.id,c)}b.go&&b.go.call(b)}};exports.default=function(){var a=document.querySelector(".dubplus-menu");a.addEventListener("click",menuDelegator),document.querySelector(".dubplus-icon").addEventListener("click",function(){a.classList.toggle("dubplus-menu-open")})};
